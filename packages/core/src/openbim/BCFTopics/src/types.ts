...
export interface BCFTopicsConfig {
  ...
  // The set of allowed topic priorities. This is exported inside the [bcf.extensions](https://github.com/buildingSMART/BCF-XML/tree/release_3_0/Documentation#bcf-file-structure).
  priorities: Set<string>;

  // The set of allowed topic labels. This is exported inside the [bcf.extensions](https://github.com/buildingSMART/BCF-XML/tree/release_3_0/Documentation#bcf-file-structure).
  labels: Set<string>;

  // The set of allowed topic stages. This is exported inside the [bcf.extensions](https://github.com/buildingSMART/BCF-XML/tree/release_3_0/Documentation#bcf-file-structure).
  stages: Set<string>;

  // The set of allowed topic users. This is exported inside the [bcf.extensions](https://github.com/buildingSMART/BCF-XML/tree/release_3_0/Documentation#bcf-file-structure).
  users: Set<string>;
