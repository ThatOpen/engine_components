...
export class UIManager extends Component<Toolbar[]> {
    ...
    get(): Toolbar[] { return this.toolbars }
    ...
    setup() {
        this.viewerContainer = this.components.renderer.get().domElement.parentElement as HTMLElement
    ...
    setContainerAlignment(container: IContainerPosition, alingment: IContainerAlingment) {
