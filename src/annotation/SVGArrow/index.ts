...
export class SVGArrow extends Component<SVGGElement> {
    ...
    private _line = document.createElementNS("http://www.w3.org/2000/svg", "line")
    private _polygon = document.createElementNS("http://www.w3.org/2000/svg", "polygon")
    private _marker = document.createElementNS("http://www.w3.org/2000/svg", "marker")
    private _arrow: SVGGElement = document.createElementNS("http://www.w3.org/2000/svg", "g")
