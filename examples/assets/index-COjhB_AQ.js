 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gi=globalThis,vi=gi.trustedTypes,so=vi?vi.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ss="$lit$",xt=`lit$${Math.random().toFixed(9).slice(2)}$`,ks="?"+xt,ul=`<${ks}>`,zt=document,Me=()=>zt.createComment(""),Pe=e=>e===null||typeof e!="object"&&typeof e!="function",On=Array.isArray,hl=e=>On(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",Yi=`[ 	
\f\r]`,xe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ro=/-->/g,ao=/>/g,It=RegExp(`>|${Yi}(?:([^\\s"'>=/]+)(${Yi}*=${Yi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),lo=/'/g,co=/"/g,Ts=/^(?:script|style|textarea|title)$/i,pl=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),m=pl(1),Ft=Symbol.for("lit-noChange"),D=Symbol.for("lit-nothing"),uo=new WeakMap,Pt=zt.createTreeWalker(zt,129);function Os(e,t){if(!On(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return so!==void 0?so.createHTML(t):t}const ml=(e,t)=>{const i=e.length-1,n=[];let o,s=t===2?"<svg>":t===3?"<math>":"",r=xe;for(let a=0;a<i;a++){const l=e[a];let d,u,c=-1,h=0;for(;h<l.length&&(r.lastIndex=h,u=r.exec(l),u!==null);)h=r.lastIndex,r===xe?u[1]==="!--"?r=ro:u[1]!==void 0?r=ao:u[2]!==void 0?(Ts.test(u[2])&&(o=RegExp("</"+u[2],"g")),r=It):u[3]!==void 0&&(r=It):r===It?u[0]===">"?(r=o??xe,c=-1):u[1]===void 0?c=-2:(c=r.lastIndex-u[2].length,d=u[1],r=u[3]===void 0?It:u[3]==='"'?co:lo):r===co||r===lo?r=It:r===ro||r===ao?r=xe:(r=It,o=void 0);const p=r===It&&e[a+1].startsWith("/>")?" ":"";s+=r===xe?l+ul:c>=0?(n.push(d),l.slice(0,c)+Ss+l.slice(c)+xt+p):l+xt+(c===-2?a:p)}return[Os(e,s+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]};class Le{constructor({strings:t,_$litType$:i},n){let o;this.parts=[];let s=0,r=0;const a=t.length-1,l=this.parts,[d,u]=ml(t,i);if(this.el=Le.createElement(d,n),Pt.currentNode=this.el.content,i===2||i===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(o=Pt.nextNode())!==null&&l.length<a;){if(o.nodeType===1){if(o.hasAttributes())for(const c of o.getAttributeNames())if(c.endsWith(Ss)){const h=u[r++],p=o.getAttribute(c).split(xt),b=/([.?@])?(.*)/.exec(h);l.push({type:1,index:s,name:b[2],strings:p,ctor:b[1]==="."?fl:b[1]==="?"?gl:b[1]==="@"?vl:Ri}),o.removeAttribute(c)}else c.startsWith(xt)&&(l.push({type:6,index:s}),o.removeAttribute(c));if(Ts.test(o.tagName)){const c=o.textContent.split(xt),h=c.length-1;if(h>0){o.textContent=vi?vi.emptyScript:"";for(let p=0;p<h;p++)o.append(c[p],Me()),Pt.nextNode(),l.push({type:2,index:++s});o.append(c[h],Me())}}}else if(o.nodeType===8)if(o.data===ks)l.push({type:2,index:s});else{let c=-1;for(;(c=o.data.indexOf(xt,c+1))!==-1;)l.push({type:7,index:s}),c+=xt.length-1}s++}}static createElement(t,i){const n=zt.createElement("template");return n.innerHTML=t,n}}function te(e,t,i=e,n){var o,s;if(t===Ft)return t;let r=n!==void 0?(o=i.o)==null?void 0:o[n]:i.l;const a=Pe(t)?void 0:t._$litDirective$;return(r==null?void 0:r.constructor)!==a&&((s=r==null?void 0:r._$AO)==null||s.call(r,!1),a===void 0?r=void 0:(r=new a(e),r._$AT(e,i,n)),n!==void 0?(i.o??(i.o=[]))[n]=r:i.l=r),r!==void 0&&(t=te(e,r._$AS(e,t.values),r,n)),t}class bl{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:n}=this._$AD,o=((t==null?void 0:t.creationScope)??zt).importNode(i,!0);Pt.currentNode=o;let s=Pt.nextNode(),r=0,a=0,l=n[0];for(;l!==void 0;){if(r===l.index){let d;l.type===2?d=new We(s,s.nextSibling,this,t):l.type===1?d=new l.ctor(s,l.name,l.strings,this,t):l.type===6&&(d=new yl(s,this,t)),this._$AV.push(d),l=n[++a]}r!==(l==null?void 0:l.index)&&(s=Pt.nextNode(),r++)}return Pt.currentNode=zt,o}p(t){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,i),i+=n.strings.length-2):n._$AI(t[i])),i++}}class We{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this.v}constructor(t,i,n,o){this.type=2,this._$AH=D,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=n,this.options=o,this.v=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=te(this,t,i),Pe(t)?t===D||t==null||t===""?(this._$AH!==D&&this._$AR(),this._$AH=D):t!==this._$AH&&t!==Ft&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):hl(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==D&&Pe(this._$AH)?this._$AA.nextSibling.data=t:this.T(zt.createTextNode(t)),this._$AH=t}$(t){var i;const{values:n,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Le.createElement(Os(o.h,o.h[0]),this.options)),o);if(((i=this._$AH)==null?void 0:i._$AD)===s)this._$AH.p(n);else{const r=new bl(s,this),a=r.u(this.options);r.p(n),this.T(a),this._$AH=r}}_$AC(t){let i=uo.get(t.strings);return i===void 0&&uo.set(t.strings,i=new Le(t)),i}k(t){On(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,o=0;for(const s of t)o===i.length?i.push(n=new We(this.O(Me()),this.O(Me()),this,this.options)):n=i[o],n._$AI(s),o++;o<i.length&&(this._$AR(n&&n._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,i);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var i;this._$AM===void 0&&(this.v=t,(i=this._$AP)==null||i.call(this,t))}}class Ri{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,n,o,s){this.type=1,this._$AH=D,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=D}_$AI(t,i=this,n,o){const s=this.strings;let r=!1;if(s===void 0)t=te(this,t,i,0),r=!Pe(t)||t!==this._$AH&&t!==Ft,r&&(this._$AH=t);else{const a=t;let l,d;for(t=s[0],l=0;l<s.length-1;l++)d=te(this,a[n+l],i,l),d===Ft&&(d=this._$AH[l]),r||(r=!Pe(d)||d!==this._$AH[l]),d===D?t=D:t!==D&&(t+=(d??"")+s[l+1]),this._$AH[l]=d}r&&!o&&this.j(t)}j(t){t===D?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class fl extends Ri{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===D?void 0:t}}class gl extends Ri{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==D)}}class vl extends Ri{constructor(t,i,n,o,s){super(t,i,n,o,s),this.type=5}_$AI(t,i=this){if((t=te(this,t,i,0)??D)===Ft)return;const n=this._$AH,o=t===D&&n!==D||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,s=t!==D&&(n===D||o);o&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,t):this._$AH.handleEvent(t)}}class yl{constructor(t,i,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){te(this,t)}}const ho=gi.litHtmlPolyfillSupport;ho==null||ho(Le,We),(gi.litHtmlVersions??(gi.litHtmlVersions=[])).push("3.2.0");const ee=(e,t,i)=>{const n=(i==null?void 0:i.renderBefore)??t;let o=n._$litPart$;if(o===void 0){const s=(i==null?void 0:i.renderBefore)??null;n._$litPart$=o=new We(t.insertBefore(Me(),s),s,void 0,i??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ns={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Is=e=>(...t)=>({_$litDirective$:e,values:t});class Ms{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,n){this.t=t,this._$AM=i,this.i=n}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ee=(e,t)=>{var i;const n=e._$AN;if(n===void 0)return!1;for(const o of n)(i=o._$AO)==null||i.call(o,t,!1),Ee(o,t);return!0},yi=e=>{let t,i;do{if((t=e._$AM)===void 0)break;i=t._$AN,i.delete(e),e=t}while((i==null?void 0:i.size)===0)},Ps=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(i===void 0)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Al(t)}};function $l(e){this._$AN!==void 0?(yi(this),this._$AM=e,Ps(this)):this._$AM=e}function Cl(e,t=!1,i=0){const n=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(n))for(let s=i;s<n.length;s++)Ee(n[s],!1),yi(n[s]);else n!=null&&(Ee(n,!1),yi(n));else Ee(this,e)}const Al=e=>{e.type==Ns.CHILD&&(e._$AP??(e._$AP=Cl),e._$AQ??(e._$AQ=$l))};class El extends Ms{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,i,n){super._$AT(t,i,n),Ps(this),this.isConnected=t._$AU}_$AO(t,i=!0){var n,o;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)==null||n.call(this):(o=this.disconnected)==null||o.call(this)),i&&(Ee(this,t),yi(this))}setValue(t){if(wl(this.t))this.t._$AI(t,this);else{const i=[...this.t._$AH];i[this.i]=t,this.t._$AI(i,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,St={scrollbar:Oc,globalStyles:Nc},nr=class T{static set config(t){this._config={...T._config,...t}}static get config(){return T._config}static addGlobalStyles(){let t=document.querySelector("style[id='bim-ui']");if(t)return;t=document.createElement("style"),t.id="bim-ui",t.textContent=St.globalStyles.cssText;const i=document.head.firstChild;i?document.head.insertBefore(t,i):document.head.append(t)}static defineCustomElement(t,i){customElements.get(t)||customElements.define(t,i)}static registerComponents(){T.init()}static init(){T.addGlobalStyles(),T.defineCustomElement("bim-button",Rc),T.defineCustomElement("bim-checkbox",ce),T.defineCustomElement("bim-color-input",Ut),T.defineCustomElement("bim-context-menu",vn),T.defineCustomElement("bim-dropdown",bt),T.defineCustomElement("bim-grid",jn),T.defineCustomElement("bim-icon",Wc),T.defineCustomElement("bim-input",Xe),T.defineCustomElement("bim-label",ue),T.defineCustomElement("bim-number-input",Y),T.defineCustomElement("bim-option",H),T.defineCustomElement("bim-panel",Vt),T.defineCustomElement("bim-panel-section",he),T.defineCustomElement("bim-selector",pe),T.defineCustomElement("bim-table",tt),T.defineCustomElement("bim-tabs",Gt),T.defineCustomElement("bim-tab",J),T.defineCustomElement("bim-table-cell",vr),T.defineCustomElement("bim-table-children",_r),T.defineCustomElement("bim-table-group",wr),T.defineCustomElement("bim-table-row",Wt),T.defineCustomElement("bim-text-input",dt),T.defineCustomElement("bim-toolbar",Vi),T.defineCustomElement("bim-toolbar-group",Bi),T.defineCustomElement("bim-toolbar-section",fe),T.defineCustomElement("bim-viewport",Mr)}static newRandomId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";let i="";for(let n=0;n<10;n++){const o=Math.floor(Math.random()*t.length);i+=t.charAt(o)}return i}};nr._config={sectionLabelOnVerticalToolbar:!1};let Te=nr;class V extends O{constructor(){super(...arguments),this._lazyLoadObserver=null,this._visibleElements=[],this.ELEMENTS_BEFORE_OBSERVER=20,this.useObserver=!1,this.elements=new Set,this.observe=t=>{if(!this.useObserver)return;for(const n of t)this.elements.add(n);const i=t.slice(this.ELEMENTS_BEFORE_OBSERVER);for(const n of i)n.remove();this.observeLastElement()}}set visibleElements(t){this._visibleElements=this.useObserver?t:[],this.requestUpdate()}get visibleElements(){return this._visibleElements}getLazyObserver(){if(!this.useObserver)return null;if(this._lazyLoadObserver)return this._lazyLoadObserver;const t=new IntersectionObserver(i=>{const n=i[0];if(!n.isIntersecting)return;const o=n.target;t.unobserve(o);const s=this.ELEMENTS_BEFORE_OBSERVER+this.visibleElements.length,r=[...this.elements][s];r&&(this.visibleElements=[...this.visibleElements,r],t.observe(r))},{threshold:.5});return t}observeLastElement(){const t=this.getLazyObserver();if(!t)return;const i=this.ELEMENTS_BEFORE_OBSERVER+this.visibleElements.length-1,n=[...this.elements][i];n&&t.observe(n)}resetVisibleElements(){const t=this.getLazyObserver();if(t){for(const i of this.elements)t.unobserve(i);this.visibleElements=[],this.observeLastElement()}}static create(t,i){const n=document.createDocumentFragment();if(t.length===0)return ee(t(),n),n.firstElementChild;if(!i)throw new Error("UIComponent: Initial state is required for statefull components.");let o=i;const s=t,r=l=>(o={...o,...l},ee(s(o),n),o);r(i);const a=()=>o;return[n.firstElementChild,r,a]}}var Ic=Object.defineProperty,Mc=Object.getOwnPropertyDescriptor,or=(e,t,i,n)=>{for(var o=Mc(t,i),s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&Ic(t,i,o),o},F;const Dn=(F=class extends O{constructor(){super(...arguments),this._previousContainer=null,this._visible=!1}get placement(){return this._placement}set placement(e){this._placement=e,this.updatePosition()}static removeMenus(){for(const e of F.menus)e instanceof F&&(e.visible=!1);F.dialog.close(),F.dialog.remove()}get visible(){return this._visible}set visible(e){var t;this._visible=e,e?(F.dialog.parentElement||document.body.append(F.dialog),this._previousContainer=this.parentElement,F.dialog.style.top=`${window.scrollY||document.documentElement.scrollTop}px`,F.dialog.append(this),F.dialog.showModal(),this.updatePosition(),this.dispatchEvent(new Event("visible"))):((t=this._previousContainer)==null||t.append(this),this._previousContainer=null,this.dispatchEvent(new Event("hidden")))}async updatePosition(){if(!(this.visible&&this._previousContainer))return;const e=this.placement??"right",t=await As(this._previousContainer,this,{placement:e,middleware:[hs(10),Cs(),$s(),ws({padding:5})]}),{x:i,y:n}=t;this.style.left=`${i}px`,this.style.top=`${n}px`}connectedCallback(){super.connectedCallback(),F.menus.push(this)}render(){return m` <slot></slot> `}},F.styles=[St.scrollbar,I`
      :host {
        pointer-events: auto;
        position: absolute;
        top: 0;
...
`},[Ci,Dd]=V.create(e=>{const{topic:t}=e,i=document.createElement("bim-text-input");i.type="area";const n=()=>{i.value="",Ci.close(),Ci.remove()};return m`
    ...
    `},{}),[Ei,zd]=V.create(e=>{const{components:t,topic:i}=e;let n;if(t){const s=[...t.get(Be).list.values()].filter(r=>r!==i);n=Lr({components:t,topics:s})[0],n.selectableRows=!0,n.hiddenColumns=["Guid","Author","Assignee","Date","DueDate"]}const o=()=>{Ei.close(),Ei.remove(),n==null||n.remove()};return m`
     <dialog>
  ...
  `},Hd=(e,t=!0)=>{const i=V.create(Fd,e);if(t){const{components:n}=e,[o,s]=i;n.get(Be).list.onItemUpdated.add(({value:r})=>{const{topic:a}=s(),{guid:l}=r;l===(a==null?void 0:a.guid)&&s()})}return i},Bd=Object.freeze(Object.defineProperty({__proto__:null,topicData:Hd},Symbol.toStringTag,{value:"Module"}));({...Bd});const Ud=e=>{const{components:t,actions:i,tags:n}=e,o=(i==null?void 0:i.dispose)??!0,s=(i==null?void 0:i.download)??!0,r=(i==null?void 0:i.visibility)??!0,a=(n==null?void 0:n.schema)??!0,l=(n==null?void 0:n.viewDefinition)??!0,d=t.get(Bt),u=({detail:c})=>{const{cell:h}=c;h.style.padding="0.25rem 0"};return m`
    <bim-table ${W(c=>{if(!c)return;const h=c;h.hiddenColumns=["modelID"];const p=[];for(const[,b]of d.groups){if(!b)continue;const v={data:{Name:b.name||b.uuid,modelID:b.uuid}};p.push(v)}h.dataTransform={Name:(b,v)=>{const{modelID:y}=v;if(typeof y!="string")return b;const g=d.groups.get(y);if(!g)return y;const _={};for(const k of g.items)_[k.id]=k.ids;let x;const{schema:w}=g.ifcMetadata;a&&w&&(x=m`
          ...
          `}let C;o&&(C=m`<bim-button @click=${()=>d.disposeGroup(g)} icon="mdi:delete"></bim-button>`);let N;r&&(N=m`<bim-button @click=${k=>{const S=t.get(ts),B=k.target;S.set(B.hasAttribute("data-model-hidden"),_),B.toggleAttribute("data-model-hidden"),B.icon=B.hasAttribute("data-model-hidden")?"mdi:eye-off":"mdi:eye"}} icon="mdi:eye"></bim-button>`);let L;return s&&(L=m`<bim-button @click=${()=>{const k=document.createElement("input");k.type="file",k.accept=".ifc",k.multiple=!1,k.addEventListener("change",async()=>{if(!(k.files&&k.files.length===1))return;const S=k.files[0],B=await S.arrayBuffer(),E=await t.get(ia).saveToIfc(g,new Uint8Array(B)),P=new File([E],S.name),$=document.createElement("a");$.href=URL.createObjectURL(P),$.download=P.name,$.click(),URL.revokeObjectURL($.href)}),k.click()}} icon="flowbite:download-solid"></bim-button>`),m`
  ...
  `,M=(e,t,i,n)=>{const o={slider:!1,min:0,max:100,step:1,prefix:null,suffix:null,onInputSet:()=>{},...n},{slider:s,min:r,max:a,step:l,suffix:d,prefix:u,onInputSet:c}=o;return m`
    <bim-number-input
      .pref=${u}
      .suffix=${d}
      .slider=${s} 
      ...
      <bim-panel-section ${W(L)} fixed label="New Topic" name="topic">
        ...
        <div style="display: flex; gap: 0.375rem">
          ...
          <bim-dropdown vertical label="Assignee" name="assignedTo">
            ${[...A].map(E=>{const P=r!=null&&r.users?r.users[E]:null,$=P?P.name:E,et=P==null?void 0:P.picture;return m`<bim-option label=${$} value=${E} .img=${et} .checked=${p===E}></bim-option>`})}
          </bim-dropdown>
        </div>
        <div style="display: flex; gap: 0.375rem">
