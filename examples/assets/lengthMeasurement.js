import{B as b,M as d,a as m}from"./web-ifc-api-DEkz78xJ.js";import{S as p}from"./stats.min-BpIepu9J.js";import{p as u,C as h,s as w,H as k,d as g}from"./index-BT4udTRq.js";import{p as f,J as i,m as c}from"./index-K5IA6oiZ.js";import{x as D,_ as x}from"./index-BOHgXXH6.js";const r=document.getElementById("container"),t=new u,y=t.get(h),e=y.create();e.scene=new w(t);e.renderer=new D(t,r);e.camera=new k(t);t.init();e.camera.controls.setLookAt(5,5,5,0,0,0);e.scene.setup();const v=t.get(g);v.create(e);e.scene.three.background=null;const M=new b(3,3,3),$=new d({color:"#6528D7"}),l=new m(M,$);l.position.set(0,1.5,0);e.scene.three.add(l);e.meshes.add(l);const n=t.get(x);n.world=e;n.enabled=!0;n.snapDistance=1;r.ondblclick=()=>n.create();window.onkeydown=o=>{(o.code==="Delete"||o.code==="Backspace")&&n.delete()};const s=new p;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());f.init();const a=i.create(()=>c`
