import{B as m,M as b,a as d}from"./web-ifc-api-D8KQoGas.js";import{S as p}from"./stats.min-GTpOrGrX.js";import{C as u,W as h,S as w,a as k,G as g}from"./index-B_l14CHw.js";import{T as f,L as a,m as c}from"./index-ByMLC5eT.js";import{X as D,i as y}from"./index-BCbMsEjB.js";import"./_commonjsHelpers-Cpj98o6Y.js";const r=document.getElementById("container"),t=new u,v=t.get(h),e=v.create();e.scene=new w(t);e.renderer=new D(t,r);e.camera=new k(t);t.init();e.camera.controls.setLookAt(5,5,5,0,0,0);e.scene.setup();const x=t.get(g);x.create(e);e.scene.three.background=null;const L=new m(3,3,3),S=new b({color:"#6528D7"}),i=new d(L,S);i.position.set(0,1.5,0);e.scene.three.add(i);e.meshes.add(i);const n=t.get(y);n.world=e;n.enabled=!0;n.snapDistance=1;r.ondblclick=()=>n.create();window.onkeydown=o=>{(o.code==="Delete"||o.code==="Backspace")&&n.delete()};const s=new p;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());f.init();const l=a.create(()=>c`
