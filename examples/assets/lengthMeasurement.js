import{B as m,M as b,a as d}from"./web-ifc-api-x-FY_BW3.js";import{S as p}from"./stats.min-BpIepu9J.js";import{p as u,C as h,o as w,W as k,d as g}from"./index-Dr4eFCtu.js";import{m as f,t as i,a as c}from"./index-tywNknxv.js";import{S as D,_ as y}from"./index-Bkd9n44b.js";const r=document.getElementById("container"),t=new u,v=t.get(h),e=v.create();e.scene=new w(t);e.renderer=new D(t,r);e.camera=new k(t);t.init();e.camera.controls.setLookAt(5,5,5,0,0,0);e.scene.setup();const x=t.get(g);x.create(e);e.scene.three.background=null;const M=new m(3,3,3),B=new b({color:"#6528D7"}),l=new d(M,B);l.position.set(0,1.5,0);e.scene.three.add(l);e.meshes.add(l);const n=t.get(y);n.world=e;n.enabled=!0;n.snapDistance=1;r.ondblclick=()=>n.create();window.onkeydown=o=>{(o.code==="Delete"||o.code==="Backspace")&&n.delete()};const s=new p;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());f.init();const a=i.create(()=>c`
