import{B as b,M as m,a as d}from"./web-ifc-api-B5wucqPq.js";import{S as p}from"./stats.min-bBCj9H3B.js";import{C as u,T as h,e as w,U as k,O as g}from"./index-0bdztiQ8.js";import{T as f,z as i,m as c}from"./index-DtbylpTq.js";import{L as D,e as y}from"./index-Dj8MPMPh.js";const r=document.getElementById("container"),t=new u,v=t.get(h),e=v.create();e.scene=new w(t);e.renderer=new D(t,r);e.camera=new k(t);t.init();e.camera.controls.setLookAt(5,5,5,0,0,0);e.scene.setup();const x=t.get(g);x.create(e);e.scene.three.background=null;const L=new b(3,3,3),M=new m({color:"#6528D7"}),a=new d(L,M);a.position.set(0,1.5,0);e.scene.three.add(a);e.meshes.add(a);const n=t.get(y);n.world=e;n.enabled=!0;n.snapDistance=1;r.ondblclick=()=>n.create();window.onkeydown=o=>{(o.code==="Delete"||o.code==="Backspace")&&n.delete()};const s=new p;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());f.init();const l=i.create(()=>c`
