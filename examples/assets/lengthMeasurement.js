import{B as b,M as m,a as d}from"./web-ifc-api-Dxv4iFj4.js";import{S as p}from"./stats.min-DYv0AsOH.js";import{p as u,C as h,e as w,v as k,O as g}from"./index-Go5pwCUJ.js";import{T as f,z as i,m as c}from"./index-DtbylpTq.js";import{P as v,t as D}from"./index-CyHGVrbF.js";const r=document.getElementById("container"),t=new u,y=t.get(h),e=y.create();e.scene=new w(t);e.renderer=new v(t,r);e.camera=new k(t);t.init();e.camera.controls.setLookAt(5,5,5,0,0,0);e.scene.setup();const x=t.get(g);x.create(e);e.scene.three.background=null;const M=new b(3,3,3),B=new m({color:"#6528D7"}),a=new d(M,B);a.position.set(0,1.5,0);e.scene.three.add(a);e.meshes.add(a);const n=t.get(D);n.world=e;n.enabled=!0;n.snapDistance=1;r.ondblclick=()=>n.create();window.onkeydown=o=>{(o.code==="Delete"||o.code==="Backspace")&&n.delete()};const s=new p;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());f.init();const l=i.create(()=>c`
