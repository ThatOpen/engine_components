import{B as b,M as m,a as d}from"./web-ifc-api-1K9lRohe.js";import{S as p}from"./stats.min-GTpOrGrX.js";import{C as u,T as h,e as w,x as k,y as g}from"./index-3A2kWhNU.js";import{T as y,z as i,m as c}from"./index-BEvRfOoQ.js";import{b as f,t as D}from"./index-DdJQ2AGj.js";import"./_commonjsHelpers-Cpj98o6Y.js";const r=document.getElementById("container"),t=new u,x=t.get(h),e=x.create();e.scene=new w(t);e.renderer=new f(t,r);e.camera=new k(t);t.init();e.camera.controls.setLookAt(5,5,5,0,0,0);e.scene.setup();const v=t.get(g);v.create(e);e.scene.three.background=null;const M=new b(3,3,3),B=new m({color:"#6528D7"}),a=new d(M,B);a.position.set(0,1.5,0);e.scene.three.add(a);e.meshes.add(a);const n=t.get(D);n.world=e;n.enabled=!0;n.snapDistance=1;r.ondblclick=()=>n.create();window.onkeydown=o=>{(o.code==="Delete"||o.code==="Backspace")&&n.delete()};const s=new p;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());y.init();const l=i.create(()=>c`
