import{l as O,c as C,t as B,a as k,b as A,S as x,aQ as D}from"./index-D_lOu8Cy.js";import{C as q,W as P,S as T,a as _,O as R,F as j,e as z,D as E}from"./index-BXecBxnk.js";const d=new q,G=d.get(P),n=G.create();n.scene=new T(d);n.scene.setup();n.scene.three.background=null;const U=document.getElementById("container");n.renderer=new _(d,U);n.camera=new R(d);await n.camera.controls.setLookAt(78,20,-2.2,26,-4,25);d.init();const W="https://thatopen.github.io/engine_fragment/resources/worker.mjs",s=d.get(j);s.init(W);n.camera.controls.addEventListener("rest",()=>s.core.update(!0));n.onCameraChanged.add(e=>{for(const[,o]of s.list)o.useCamera(e.three);s.core.update(!0)});s.list.onItemSet.add(({value:e})=>{e.useCamera(n.camera.three),n.scene.three.add(e.object),s.core.update(!0)});const Q=["https://thatopen.github.io/engine_components/resources/frags/school_arq.frag","https://thatopen.github.io/engine_components/resources/frags/school_str.frag"];await Promise.all(Q.map(async e=>{var p;const o=(p=e.split("/").pop())==null?void 0:p.split(".").shift();if(!o)return null;const l=await(await fetch(e)).arrayBuffer();return s.core.load(l,{modelId:o})}));const c=d.get(z),I=()=>{c.list.clear(),c.addFromModels();const e=c.get();return c.list.clear(),e},S=async e=>{const o=[...s.list.keys()].find(w=>/arq/.test(w));if(!o)return null;const r=s.list.get(o);if(!r)return null;const l=await r.getItemsOfCategories([new RegExp(`^${e}$`)]),g=Object.values(l).flat().slice(0,1),f={[o]:new Set(g)};c.list.clear(),await c.addFromModelIdMap(f);const h=c.get();return c.list.clear(),h},J=async e=>{const o=n.camera;if(!o.hasCameraControls())return;const{position:r,target:l}=await c.getCameraOrientation(e);await o.controls.setLookAt(r.x,r.y,r.z,l.x,l.y,l.z,!0)};let v=[];const $=e=>{const o=new D(e);n.scene.three.add(o),v.push(o)},K=()=>{const e=d.get(E);for(const o of v)e.destroy(o);v=[]};O.init();const u=C.create(()=>{let e,o;const r=({target:t})=>{t.loading=!0;const i=I(),a=new x;i.getBoundingSphere(a),n.camera.controls.fitToSphere(a,!0),t.loading=!1},l=()=>{const t=I();$(t)},p=async({target:t})=>{if(!e)return;t.loading=!0;const[i]=e.value,a=await S(i);if(!a){t.loading=!1;return}$(a),t.loading=!1},g=async t=>{if(!t)return;const i=[...s.list.keys()].find(y=>/arq/.test(y));if(!i)return;const a=s.list.get(i);if(!a)return;const m=t;e=m,m.innerHTML="";const M=await a.getItemsWithGeometryCategories();for(const[y,H]of M.entries()){const L=C.create(()=>k`<bim-option ?checked=${y===0} label=${H}></bim-option>`);m.append(L)}},f=async({target:t})=>{if(!e)return;t.loading=!0;const[i]=e.value,a=await S(i);if(!a){t.loading=!1;return}const m=new x;a.getBoundingSphere(m),n.camera.controls.fitToSphere(m,!0),t.loading=!1},h=()=>{K()},w=t=>{t&&(o=t)},F=async({target:t})=>{if(!o)return;t.loading=!0;const[i]=o.value;await J(i),t.loading=!1};return k`
