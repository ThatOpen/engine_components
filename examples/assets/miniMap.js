import"./web-ifc-api-B5wucqPq.js";import{S as l}from"./stats.min-bBCj9H3B.js";import{T as b,z as c,m as r}from"./index-DtbylpTq.js";import{C as d,T as p,e as u,m as f,U as g,O as h,a as v,H as x}from"./index-0bdztiQ8.js";const k=document.getElementById("container"),o=new d,w=o.get(p),t=w.create();t.scene=new u(o);t.renderer=new f(o,k);t.camera=new g(o);t.scene.setup();o.init();const y=o.get(h);y.create(t);t.camera.controls.setLookAt(1,2,-2,-2,0,-5);t.scene.three.background=null;const z=new v(o),$=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),S=await $.arrayBuffer(),T=new Uint8Array(S),B=z.load(T);t.scene.three.add(B);const L=new x(o),n=L.create(t),U=document.getElementById("minimap"),m=n.renderer.domElement;m.style.borderRadius="12px";U.append(m);n.resize();const a=new l;a.showPanel(2);document.body.append(a.dom);a.dom.style.left="0px";a.dom.style.zIndex="unset";t.renderer.onBeforeUpdate.add(()=>a.begin());t.renderer.onAfterUpdate.add(()=>a.end());b.init();const i=n.getSize(),s=c.create(()=>r`
    ...
    `);document.body.append(s);const C=c.create(()=>r`
