import"./web-ifc-api-nU1-R_1k.js";import{S as l}from"./stats.min-GTpOrGrX.js";import{T as b,z as c,m as r}from"./index-BEvRfOoQ.js";import{C as d,W as p,S as u,d as f,a as g,G as h,F as v,s as x}from"./index-C8rcJyf0.js";import"./_commonjsHelpers-Cpj98o6Y.js";const k=document.getElementById("container"),o=new d,w=o.get(p),t=w.create();t.scene=new u(o);t.renderer=new f(o,k);t.camera=new g(o);t.scene.setup();o.init();const y=o.get(h);y.create(t);t.camera.controls.setLookAt(1,2,-2,-2,0,-5);t.scene.three.background=null;const z=new v(o),$=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),S=await $.arrayBuffer(),B=new Uint8Array(S),C=z.load(B);t.scene.three.add(C);const L=new x(o),n=L.create(t),E=document.getElementById("minimap"),m=n.renderer.domElement;m.style.borderRadius="12px";E.append(m);n.resize();const a=new l;a.showPanel(2);document.body.append(a.dom);a.dom.style.left="0px";a.dom.style.zIndex="unset";t.renderer.onBeforeUpdate.add(()=>a.begin());t.renderer.onAfterUpdate.add(()=>a.end());b.init();const s=n.getSize(),i=c.create(()=>r`
