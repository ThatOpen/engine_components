import{C as c}from"./web-ifc-api-BC8YMRiS.js";import{S as b}from"./stats.min-GTpOrGrX.js";import{p,a as m,m as u}from"./index-DyM33b1I.js";import{f as d,p as f,s as h,k as g,N as v,u as x}from"./index-DQ59awSV.js";import"./import-wrapper-prod-LhqN7JJy.js";import{P as $}from"./index-CvD1WrkP.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./renderer-with-2d-BWBYTINn.js";const k=document.getElementById("container"),t=new d,E=t.get(f),a=E.create();a.scene=new h(t);a.renderer=new $(t,k);a.camera=new g(t);a.scene.three.background=null;t.init();a.camera.controls.setLookAt(12,6,8,0,0,-10);a.scene.setup();const r=t.get(v);r.config.color.set(6710886);const w=r.create(a),o=new b;o.showPanel(2);document.body.append(o.dom);o.dom.style.zIndex="unset";o.dom.style.left="0px";a.renderer.onBeforeUpdate.add(()=>o.begin());a.renderer.onAfterUpdate.add(()=>o.end());const y=new x(t),S=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),R=await S.arrayBuffer(),A=new Uint8Array(R),C=y.load(A);a.scene.three.add(C);const{postproduction:n}=a.renderer;n.enabled=!0;n.customEffects.excludedMeshes.push(w.three);const s=n.n8ao.configuration;p.init();const l=m.create(()=>u`
