import"./web-ifc-api-CuDRTh9k.js";import{W as b,C as c}from"./index-CeXOB-rx.js";import{S as p}from"./stats.min-GTpOrGrX.js";import{T as d,L as m,m as u}from"./index-C8nqhRYO.js";import{C as f,W as h,S as g,a as v,G as x,F as $}from"./index-MG2l5tzA.js";import"./_commonjsHelpers-Cpj98o6Y.js";const k=document.getElementById("container"),t=new f,E=t.get(h),a=E.create();a.scene=new g(t);a.renderer=new b(t,k);a.camera=new v(t);a.scene.three.background=null;t.init();a.camera.controls.setLookAt(12,6,8,0,0,-10);a.scene.setup();const w=t.get(x),r=w.create(a);r.config.color.set(6710886);a.scene.three.background=null;const y=new $(t),S=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),C=await S.arrayBuffer(),G=new Uint8Array(C),A=y.load(G);a.scene.three.add(A);const{postproduction:n}=a.renderer;n.enabled=!0;n.customEffects.excludedMeshes.push(r.three);const s=n.n8ao.configuration,o=new p;o.showPanel(2);document.body.append(o.dom);o.dom.style.left="0px";o.dom.style.zIndex="unset";a.renderer.onBeforeUpdate.add(()=>o.begin());a.renderer.onAfterUpdate.add(()=>o.end());d.init();const l=m.create(()=>u`
