import{C as c}from"./web-ifc-api-1K9lRohe.js";import{S as b}from"./stats.min-GTpOrGrX.js";import{T as p,z as m,m as u}from"./index-BEvRfOoQ.js";import{C as d,T as f,e as h,x as g,y as v,a as x}from"./index-3A2kWhNU.js";import{b as $}from"./index-DdJQ2AGj.js";import"./_commonjsHelpers-Cpj98o6Y.js";const k=document.getElementById("container"),t=new d,E=t.get(f),a=E.create();a.scene=new h(t);a.renderer=new $(t,k);a.camera=new g(t);a.scene.three.background=null;t.init();a.camera.controls.setLookAt(12,6,8,0,0,-10);a.scene.setup();const y=t.get(v),r=y.create(a);r.config.color.set(6710886);a.scene.three.background=null;const w=new x(t),S=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),C=await S.arrayBuffer(),A=new Uint8Array(C),G=w.load(A);a.scene.three.add(G);const{postproduction:n}=a.renderer;n.enabled=!0;n.customEffects.excludedMeshes.push(r.three);const s=n.n8ao.configuration,o=new b;o.showPanel(2);document.body.append(o.dom);o.dom.style.left="0px";o.dom.style.zIndex="unset";a.renderer.onBeforeUpdate.add(()=>o.begin());a.renderer.onAfterUpdate.add(()=>o.end());p.init();const l=m.create(()=>u`
