import{a as x,M as f,B as w,h as k}from"./index-D7EC26VF.js";import{C as O,W as S,S as M,O as C,d as E,F as L}from"./graphic-vertex-picker-C_xseSgk.js";import{a as y,R as h,m as g}from"./index-bERBRksd.js";import{P as R,a as u}from"./index-WsJUHyIb.js";import{O as D}from"./index-BXQwErj3.js";import"./index-BEyww2em.js";const s=new O,I=s.get(S),a=I.create();a.scene=new M(s);a.scene.setup();a.scene.three.background=null;const G=document.getElementById("container");a.renderer=new R(s,G);a.camera=new C(s);await a.camera.controls.setLookAt(68,23,-8.5,21.5,-5.5,23);s.init();const A=s.get(E),F=A.create(a);F.config.color.set(6710886);a.scene.three.background=null;const W="https://thatopen.github.io/engine_fragment/resources/worker.mjs",l=s.get(L);l.init(W);a.camera.controls.addEventListener("rest",()=>l.core.update(!0));a.onCameraChanged.add(e=>{for(const[,r]of l.list)r.useCamera(e.three);l.core.update(!0)});l.list.onItemSet.add(({value:e})=>{e.useCamera(a.camera.three),a.scene.three.add(e.object),l.core.update(!0)});const _=["https://thatopen.github.io/engine_components/resources/frags/school_arq.frag"];await Promise.all(_.map(async e=>{var p;const r=(p=e.split("/").pop())==null?void 0:p.split(".").shift();if(!r)return null;const P=await(await fetch(e)).arrayBuffer();return l.core.load(P,{modelId:r})}));a.renderer.postproduction.enabled=!0;a.dynamicAnchor=!1;l.core.models.materials.list.onItemSet.add(({value:e})=>{"isLodMaterial"in e&&e.isLodMaterial&&a.renderer.postproduction.basePass.isolatedMaterials.push(e)});const v=l.list.values().next().value,$=s.get(D);$.world=a;const B=await v.getItemsOfCategories([/IFCWALL/]),j=B.IFCWALL,[H,N]=j;$.addItems({[v.modelId]:new Set([H,N])});const c=new x;c.showPanel(2);document.body.append(c.dom);c.dom.style.left="0px";c.dom.style.zIndex="unset";a.renderer.onBeforeUpdate.add(()=>c.begin());a.renderer.onAfterUpdate.add(()=>c.end());y.init();const{aoPass:i,outlinePass:o,edgesPass:b}=a.renderer.postproduction,n={radius:.25,distanceExponent:1,thickness:1,scale:1,samples:16,distanceFallOff:1,screenSpaceRadius:!0},t={lumaPhi:10,depthPhi:2,normalPhi:3,radius:4,radiusExponent:1,rings:2,samples:16};i.updateGtaoMaterial(n);i.updatePdMaterial(t);const m=new f(new w(1,1,1),new k({color:65280}));m.position.set(10,0,0);a.scene.three.add(m);a.renderer.postproduction.excludedObjectsPass.addExcludedMaterial(m.material);const d=h.create(()=>g`
