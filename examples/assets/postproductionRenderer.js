<<<<<<< Updated upstream
import{C as c}from"./web-ifc-api-C62xsSvk.js";import{S as b}from"./stats.min-BpIepu9J.js";import{p,J as m,m as u}from"./index-K5IA6oiZ.js";import{p as d,C as f,i as h,k as g,u as v,a as x}from"./index-CTnQ5y92.js";import{x as $}from"./index-BJbcJwBt.js";const k=document.getElementById("container"),t=new d,E=t.get(f),a=E.create();a.scene=new h(t);a.camera=new g(t);a.renderer=new $(t,k);a.scene.three.background=null;t.init();a.camera.controls.setLookAt(12,6,8,0,0,-10);a.scene.setup();const r=t.get(v);r.config.color.set(6710886);const w=r.create(a);a.scene.three.background=null;const y=new x(t),S=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),C=await S.arrayBuffer(),A=new Uint8Array(C),G=y.load(A);a.scene.three.add(G);const{postproduction:n}=a.renderer;n.enabled=!0;n.customEffects.excludedMeshes.push(w.three);const s=n.n8ao.configuration,o=new b;o.showPanel(2);document.body.append(o.dom);o.dom.style.left="0px";o.dom.style.zIndex="unset";a.renderer.onBeforeUpdate.add(()=>o.begin());a.renderer.onAfterUpdate.add(()=>o.end());p.init();const l=m.create(()=>u`
=======
import{C as c}from"./web-ifc-api-CwSt8Jc1.js";import{S as b}from"./stats.min-BpIepu9J.js";import{p,J as m,m as u}from"./index-K5IA6oiZ.js";import{p as d,C as f,s as h,H as g,d as v,u as x}from"./index-CIBiH68K.js";import{x as $}from"./index-_0TcChOK.js";const k=document.getElementById("container"),t=new d,E=t.get(f),a=E.create();a.scene=new h(t);a.camera=new g(t);a.renderer=new $(t,k);a.scene.three.background=null;t.init();a.camera.controls.setLookAt(12,6,8,0,0,-10);a.scene.setup();const r=t.get(v);r.config.color.set(6710886);const w=r.create(a);a.scene.three.background=null;const y=new x(t),S=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),C=await S.arrayBuffer(),A=new Uint8Array(C),G=y.load(A);a.scene.three.add(G);const{postproduction:n}=a.renderer;n.enabled=!0;n.customEffects.excludedMeshes.push(w.three);const s=n.n8ao.configuration,o=new b;o.showPanel(2);document.body.append(o.dom);o.dom.style.left="0px";o.dom.style.zIndex="unset";a.renderer.onBeforeUpdate.add(()=>o.begin());a.renderer.onAfterUpdate.add(()=>o.end());p.init();const l=m.create(()=>u`
>>>>>>> Stashed changes
