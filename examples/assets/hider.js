import"./web-ifc-api-5J0YW9AE.js";import{S as k}from"./stats.min-BpIepu9J.js";import{m as S,t as r,a as l}from"./index-tywNknxv.js";import{p as x,C as v,s as C,i as F,k as _,d as j,h as A,a as L,_ as $,A as M}from"./index-CAlyvYyy.js";const B=document.getElementById("container"),e=new x,E=e.get(v),t=E.create();t.scene=new C(e);t.renderer=new F(e,B);t.camera=new _(e);e.init();t.camera.controls.setLookAt(12,6,8,0,0,-10);t.scene.setup();const I=e.get(j);I.create(t);t.scene.three.background=null;const b=e.get(A),N=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),O=await N.arrayBuffer(),U=new Uint8Array(O),i=b.load(U);t.scene.three.add(i);const q=await fetch("https://thatopen.github.io/engine_components/resources/small.json");i.setLocalProperties(await q.json());const d=e.get(L),P=await fetch("https://thatopen.github.io/engine_components/resources/small-relations.json"),R=d.getRelationsMapFromJSON(await P.text());d.setRelationMap(i,R);const f=e.get($),o=e.get(M);o.byEntity(i);await o.bySpatialStructure(i);const a=new k;a.showPanel(2);document.body.append(a.dom);a.dom.style.left="0px";a.dom.style.zIndex="unset";t.renderer.onBeforeUpdate.add(()=>a.begin());t.renderer.onAfterUpdate.add(()=>a.end());S.init();const g={},z=Object.keys(o.list.spatialStructures);for(const n of z)g[n]=!0;const h={},D=Object.keys(o.list.entities);for(const n of D)h[n]=!0;const s=r.create(()=>l`
