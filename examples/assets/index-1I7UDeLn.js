...
`},[Ci,Dd]=V.create(e=>{const{topic:t}=e,i=document.createElement("bim-text-input");i.type="area";const n=()=>{i.value="",Ci.close(),Ci.remove()};return m`
    ...
    `},{}),[Ei,zd]=V.create(e=>{const{components:t,topic:i}=e;let n;if(t){const s=[...t.get(He).list.values()].filter(r=>r!==i);n=Rr({components:t,topics:s})[0],n.selectableRows=!0,n.hiddenColumns=["Guid","Author","Assignee","Date","DueDate"]}const o=()=>{Ei.close(),Ei.remove(),n==null||n.remove()};return m`
     <dialog>
