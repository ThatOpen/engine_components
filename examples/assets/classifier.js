import{C as s}from"./web-ifc-api-BC8YMRiS.js";import{S as a}from"./stats.min-GTpOrGrX.js";import{p as c,a as m,m as p}from"./index-DyM33b1I.js";import{a as d,W as u,S as b,b as f,c as C}from"./index-B99Vyz6D.js";import{G as w}from"./index-vdN6D13n.js";import{C as y}from"./index-zq8_pZ9C.js";import{F as g}from"./index-Cy4SZRUH.js";import"./_commonjsHelpers-Cpj98o6Y.js";const S=document.getElementById("container"),n=new d,F=n.get(u),r=F.create();r.scene=new b(n);r.renderer=new f(n,S);r.camera=new C(n);n.init();r.camera.controls.setLookAt(12,6,8,0,0,-10);r.scene.setup();const A=n.get(w);A.create(r);const E=new g(n),I=await fetch("../../../../../resources/small.frag"),L=await I.arrayBuffer(),R=new Uint8Array(L),i=E.load(R);r.scene.three.add(i);const o=n.get(y);o.byEntity(i);o.byStorey(i);o.byModel(i.uuid,i);c.init();const $=o.find({entities:["IFCWALLSTANDARDCASE"]}),h=o.find({entities:["IFCSLAB"]}),x=o.find({entities:["IFCMEMBER","IFCPLATE"]}),B=o.find({entities:["IFCFURNISHINGELEMENT"]}),M=o.find({entities:["IFCDOOR"]}),W=o.find({models:[i.uuid]}),e=new s,D=m.create(()=>p`
