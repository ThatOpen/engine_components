import{C as l}from"./web-ifc-api-eJ7dR4yy.js";import{S as a}from"./stats.min-GTpOrGrX.js";import{k as c,C as m,b as p}from"./index-CA2cPfXk.js";import{a as d,W as u,S as b,b as f,c as C}from"./index-BRIP3dnE.js";import{G as w}from"./index-aZ7tPJp1.js";import{C as g}from"./index-12O_c3WE.js";import{F as y}from"./index-DUv5fNdI.js";import"./_commonjsHelpers-Cpj98o6Y.js";const S=document.getElementById("container"),n=new d,F=n.get(u),r=F.create();r.scene=new b(n);r.renderer=new f(n,S);r.camera=new C(n);n.init();r.camera.controls.setLookAt(12,6,8,0,0,-10);r.scene.setup();const A=n.get(w);A.create(r);const E=new y(n),I=await fetch("../../../../../resources/small.frag"),L=await I.arrayBuffer(),R=new Uint8Array(L),s=E.load(R);r.scene.three.add(s);const o=n.get(g);o.byEntity(s);o.byStorey(s);o.byModel(s.uuid,s);c.registerComponents();const $=o.find({entities:["IFCWALLSTANDARDCASE"]}),h=o.find({entities:["IFCSLAB"]}),x=o.find({entities:["IFCMEMBER","IFCPLATE"]}),B=o.find({entities:["IFCFURNISHINGELEMENT"]}),M=o.find({entities:["IFCDOOR"]}),W=o.find({models:[s.uuid]}),e=new l,k=m.create(()=>p`
