import{ag as m,C as u}from"./web-ifc-api-1K9lRohe.js";import{S as p}from"./stats.min-GTpOrGrX.js";import{T as d,z as a,m as c}from"./index-BEvRfOoQ.js";import{C as b,T as C,e as f,m as w,x as g,y,a as I,B as h}from"./index-3A2kWhNU.js";import"./_commonjsHelpers-Cpj98o6Y.js";const T=document.getElementById("container"),s=new b,A=s.get(C),t=A.create();t.scene=new f(s);t.renderer=new w(s,T);t.camera=new g(s);s.init();t.camera.controls.setLookAt(12,6,8,0,0,-10);t.scene.setup();const E=s.get(y);E.create(t);t.scene.three.background=null;const L=new I(s),F=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),R=await F.arrayBuffer(),S=new Uint8Array(R),i=L.load(S);t.scene.three.add(i);const B=await fetch("https://thatopen.github.io/engine_components/resources/small.json");i.setLocalProperties(await B.json());const o=s.get(h);o.byEntity(i);o.byIfcRel(i,m,"storeys");o.byModel(i.uuid,i);const N=o.find({entities:["IFCWALLSTANDARDCASE"]}),$=o.find({entities:["IFCSLAB"]}),U=o.find({entities:["IFCMEMBER","IFCPLATE"]}),v=o.find({entities:["IFCFURNISHINGELEMENT"]}),D=o.find({entities:["IFCDOOR"]}),k=o.find({models:[i.uuid]}),l=new p;l.showPanel(2);document.body.append(l.dom);l.dom.style.left="0px";l.dom.style.zIndex="unset";t.renderer.onBeforeUpdate.add(()=>l.begin());t.renderer.onAfterUpdate.add(()=>l.end());d.init();const e=new u,r=a.create(()=>c`
