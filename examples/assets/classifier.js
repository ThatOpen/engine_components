import{ay as u,C as m}from"./web-ifc-api-z0lP7pyY.js";import{S as d}from"./stats.min-GTpOrGrX.js";import{p,a,m as c}from"./index-DyM33b1I.js";import{p as b,C,i as f,n as w,k as I,a as g,u as y,c as A}from"./index-CDtayhLQ.js";import"./_commonjsHelpers-Cpj98o6Y.js";const E=document.getElementById("container"),s=new b,L=s.get(C),t=L.create();t.scene=new f(s);t.renderer=new w(s,E);t.camera=new I(s);s.init();t.camera.controls.setLookAt(12,6,8,0,0,-10);t.scene.setup();const F=s.get(g);F.create(t);t.scene.three.background=null;const R=new y(s),S=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),h=await S.arrayBuffer(),T=new Uint8Array(h),i=R.load(T);t.scene.three.add(i);const o=s.get(A);o.byEntity(i);o.byIfcRel(i,u,"storeys");o.byModel(i.uuid,i);const $=o.find({entities:["IFCWALLSTANDARDCASE"]}),N=o.find({entities:["IFCSLAB"]}),k=o.find({entities:["IFCMEMBER","IFCPLATE"]}),U=o.find({entities:["IFCFURNISHINGELEMENT"]}),v=o.find({entities:["IFCDOOR"]}),B=o.find({models:[i.uuid]}),l=new d;l.showPanel(2);document.body.append(l.dom);l.dom.style.left="0px";l.dom.style.zIndex="unset";t.renderer.onBeforeUpdate.add(()=>l.begin());t.renderer.onAfterUpdate.add(()=>l.end());p.init();const e=new m,r=a.create(()=>c`
