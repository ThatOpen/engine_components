import{l as p,c as m,a as d,b}from"./index-D_lOu8Cy.js";import{C as u,W as h,S as g,a as f,O as w,F as v}from"./index-BXecBxnk.js";import{G as P}from"./index-BfndH2zJ.js";const r=new u,k=r.get(h),e=k.create();e.scene=new g(r);e.scene.setup();e.scene.three.background=null;const F=document.getElementById("container");e.renderer=new f(r,F);e.camera=new w(r);await e.camera.controls.setLookAt(68,23,-8.5,21.5,-5.5,23);r.init();const C=r.get(P).create(e),O="https://thatopen.github.io/engine_fragment/resources/worker.mjs",n=r.get(v);n.init(O);e.camera.controls.addEventListener("rest",()=>n.core.update(!0));e.onCameraChanged.add(t=>{for(const[,o]of n.list)o.useCamera(t.three);n.core.update(!0)});n.list.onItemSet.add(({value:t})=>{t.useCamera(e.camera.three),e.scene.three.add(t.object),n.core.update(!0)});const j=["https://thatopen.github.io/engine_components/resources/frags/school_arq.frag"];await Promise.all(j.map(async t=>{var l;const o=(l=t.split("/").pop())==null?void 0:l.split(".").shift();if(!o)return null;const s=await(await fetch(t)).arrayBuffer();return n.core.load(s,{modelId:o})}));e.camera.projection.onChanged.add(()=>{const t=e.camera.projection.current;C.fade=t==="Perspective"});p.init();const c=m.create(()=>d`
