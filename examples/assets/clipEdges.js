import{B as M,M as y,a as d,b as c,L as b}from"./web-ifc-api-Dxv4iFj4.js";import{S as f}from"./stats.min-DYv0AsOH.js";import{T as k,z as m,m as p}from"./index-DtbylpTq.js";import{C as x,T as v,e as L,U as P,O as B,b as C,S as I}from"./index-BgsLex8O.js";import{L as $,A as z,b as S}from"./index-CVY0gyOM.js";const u=document.getElementById("container"),o=new x,D=o.get(v),e=D.create();e.scene=new L(o);e.renderer=new $(o,u);e.camera=new P(o);e.renderer.postproduction.enabled=!0;e.renderer.postproduction.customEffects.outlineEnabled=!0;o.init();e.camera.controls.setLookAt(12,6,8,0,0,-10);e.scene.setup();const h=o.get(B);h.config.color.setHex(6710886);const T=h.create(e);e.renderer.postproduction.customEffects.excludedMeshes.push(T.three);e.scene.three.background=null;const g=new M(3,3,3),w=new y({color:"#6528D7"}),a=new d(g,w);a.position.set(-2,1.5,0);e.scene.three.add(a);e.meshes.add(a);const l=new d(g,w);l.position.set(2,1.5,0);e.scene.three.add(l);e.meshes.add(l);const A=o.get(C);A.get(e);const n=o.get(I);n.enabled=!0;const r=o.get(z);n.Type=S;const E=new c({color:"lightblue",side:2}),O=new b({color:"blue"}),U=new c({color:"blue",opacity:.5,side:2,transparent:!0});r.styles.create("Red lines",new Set([a]),e,O,E,U);const F=new c({color:"salmon",side:2}),G=new b({color:"red"}),R=new c({color:"red",opacity:.5,side:2,transparent:!0});r.styles.create("Blue lines",new Set([l]),e,G,F,R);u.ondblclick=()=>{n.enabled&&n.create(e)};window.onkeydown=t=>{(t.code==="Delete"||t.code==="Backspace")&&n.enabled&&n.delete(e)};const s=new f;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());k.init();const i=m.create(()=>p`
