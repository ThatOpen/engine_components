import{B as M,M as y,a as d,b as c,L as b}from"./web-ifc-api-5J0YW9AE.js";import{S as k}from"./stats.min-BpIepu9J.js";import{m as f,t as m,a as p}from"./index-tywNknxv.js";import{p as x,C as v,s as P,k as B,d as C,H as I,R as L}from"./index-ChhmFBcB.js";import{S as $,m as S,d as D}from"./index-CK9PbCWD.js";const u=document.getElementById("container"),o=new x,z=o.get(v),e=z.create();e.scene=new P(o);e.renderer=new $(o,u);e.camera=new B(o);e.renderer.postproduction.enabled=!0;e.renderer.postproduction.customEffects.outlineEnabled=!0;o.init();e.camera.controls.setLookAt(12,6,8,0,0,-10);e.scene.setup();const h=o.get(C);h.config.color.setHex(6710886);const E=h.create(e);e.renderer.postproduction.customEffects.excludedMeshes.push(E.three);e.scene.three.background=null;const g=new M(3,3,3),w=new y({color:"#6528D7"}),a=new d(g,w);a.position.set(-2,1.5,0);e.scene.three.add(a);e.meshes.add(a);const l=new d(g,w);l.position.set(2,1.5,0);e.scene.three.add(l);e.meshes.add(l);const R=o.get(I);R.get(e);const n=o.get(L);n.enabled=!0;const r=o.get(S);n.Type=D;const A=new c({color:"lightblue",side:2}),H=new b({color:"blue"}),O=new c({color:"blue",opacity:.5,side:2,transparent:!0});r.styles.create("Red lines",new Set([a]),e,H,A,O);const F=new c({color:"salmon",side:2}),G=new b({color:"red"}),T=new c({color:"red",opacity:.5,side:2,transparent:!0});r.styles.create("Blue lines",new Set([l]),e,G,F,T);u.ondblclick=()=>{n.enabled&&n.create(e)};window.onkeydown=t=>{(t.code==="Delete"||t.code==="Backspace")&&n.enabled&&n.delete(e)};const s=new k;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());f.init();const i=m.create(()=>p`
