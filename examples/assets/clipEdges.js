import{B as M,M as y,a as d,b as c,L as b}from"./web-ifc-api-BlC6WGhG.js";import{S as f}from"./stats.min-ClRtqrR4.js";import{T as x,z as m,m as p}from"./index-DtbylpTq.js";import{C as k,T as v,e as P,x as B,N as C,c as I,O as L}from"./index-D5jRLLPO.js";import{b as $,a as z,e as D}from"./index-DgoiOeDy.js";const u=document.getElementById("container"),o=new k,O=o.get(v),e=O.create();e.scene=new P(o);e.renderer=new $(o,u);e.camera=new B(o);e.renderer.postproduction.enabled=!0;e.renderer.postproduction.customEffects.outlineEnabled=!0;o.init();e.camera.controls.setLookAt(12,6,8,0,0,-10);e.scene.setup();const T=o.get(C),h=T.create(e);h.config.color.setHex(6710886);e.renderer.postproduction.customEffects.excludedMeshes.push(h.three);e.scene.three.background=null;const g=new M(3,3,3),w=new y({color:"#6528D7"}),a=new d(g,w);a.position.set(-2,1.5,0);e.scene.three.add(a);e.meshes.add(a);const l=new d(g,w);l.position.set(2,1.5,0);e.scene.three.add(l);e.meshes.add(l);const E=o.get(I);E.get(e);const n=o.get(L);n.enabled=!0;const r=o.get(z);n.Type=D;const S=new c({color:"lightblue",side:2}),A=new b({color:"blue"}),F=new c({color:"blue",opacity:.5,side:2,transparent:!0});r.styles.create("Red lines",new Set([a]),e,A,S,F);const G=new c({color:"salmon",side:2}),N=new b({color:"red"}),R=new c({color:"red",opacity:.5,side:2,transparent:!0});r.styles.create("Blue lines",new Set([l]),e,N,G,R);u.ondblclick=()=>{n.enabled&&n.create(e)};window.onkeydown=t=>{(t.code==="Delete"||t.code==="Backspace")&&n.enabled&&n.delete(e)};const s=new f;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());x.init();const i=m.create(()=>p`
