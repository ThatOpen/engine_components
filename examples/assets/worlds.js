import{m as o,B as r,M as a,C as s,D as c,A as l}from"./web-ifc-api-CmZKgq4q.js";import{k as m,C as p,b}from"./index-CA2cPfXk.js";import{a as d,W as u,S as h,b as g,c as f}from"./index-D-_Rgxo_.js";const w=document.getElementById("container"),i=new d,y=i.get(u),e=y.create();e.scene=new h(i);e.renderer=new g(i,w);e.camera=new f(i);i.init();const x=new o({color:"#6528D7"}),C=new r,k=new a(C,x);e.scene.three.add(k);e.scene.setup();e.camera.controls.setLookAt(3,3,3,0,0,0);m.registerComponents();const v=p.create(()=>b`
