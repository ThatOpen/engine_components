import{Z as r,B as l,a as c,C as m}from"./web-ifc-api-Df2dhA4n.js";import{T as d,z as i,m as a}from"./index-DtbylpTq.js";import{S as b}from"./stats.min-GTpOrGrX.js";import{C as u,T as p,e as g,m as h,x as w}from"./index-CC2Loeen.js";import"./_commonjsHelpers-Cpj98o6Y.js";const y=document.getElementById("container"),o=new u,f=o.get(p),e=f.create();e.scene=new g(o);e.renderer=new h(o,y);e.camera=new w(o);o.init();e.scene.setup();e.scene.three.background=null;const v=new r({color:"#6528D7"}),x=new l,C=new c(x,v);e.scene.three.add(C);e.camera.controls.setLookAt(3,3,3,0,0,0);const n=new b;n.showPanel(2);document.body.append(n.dom);n.dom.style.left="0px";n.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>n.begin());e.renderer.onAfterUpdate.add(()=>n.end());d.init();const s=i.create(()=>a`
