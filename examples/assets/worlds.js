import{ac as l,B as c,a as m,C as d,D as b,A as u}from"./web-ifc-api-BXZoUgQp.js";import{d as p,R as a,m as r}from"./index-CqPyogbW.js";import{o as h,a as f,L as g,M as w,N as y}from"./index-CbQqmTVP.js";import{S as L}from"./stats.min-GTpOrGrX.js";import"./_commonjsHelpers-Cpj98o6Y.js";const v=document.getElementById("container"),s=new h,k=s.get(f),e=k.create();e.scene=new g(s);e.renderer=new w(s,v);e.camera=new y(s);s.init();e.scene.three.background=null;const x=new l({color:"#6528D7"}),A=new c,B=new m(A,x);e.scene.three.add(B);e.scene.setup();e.camera.controls.setLookAt(3,3,3,0,0,0);const n=new L;n.showPanel(2);document.body.append(n.dom);n.dom.style.left="0px";n.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>n.begin());e.renderer.onAfterUpdate.add(()=>n.end());p.init();const i=a.create(()=>r`
