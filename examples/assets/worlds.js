import{k as l,B as c,M as m,C as d,a_ as p,a$ as b}from"./web-ifc-api-BC8YMRiS.js";import{p as u,a,m as r}from"./index-DyM33b1I.js";import{f as h,p as f,s as g,i as w,k as y}from"./index-BmA4XTIx.js";import{S as v}from"./stats.min-GTpOrGrX.js";import"./_commonjsHelpers-Cpj98o6Y.js";const k=document.getElementById("container"),i=new h,L=i.get(f),e=L.create();e.scene=new g(i);e.renderer=new w(i,k);e.camera=new y(i);i.init();e.scene.three.background=null;const $=new l({color:"#6528D7"}),x=new c,B=new m(x,$);e.scene.three.add(B);e.scene.setup();e.camera.controls.setLookAt(3,3,3,0,0,0);const n=new v;n.showPanel(2);document.body.append(n.dom);n.dom.style.left="0px";n.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>n.begin());e.renderer.onAfterUpdate.add(()=>n.end());u.init();const s=a.create(()=>r`
    ...
    `);document.body.append(s);const A=a.create(()=>r`
