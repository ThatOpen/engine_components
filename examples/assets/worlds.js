import{a6 as l,B as c,a as m,C as d,D as p,A as b}from"./web-ifc-api-DEkz78xJ.js";import{p as u,J as a,m as r}from"./index-K5IA6oiZ.js";import{p as h,C as f,s as g,i as w,H as y}from"./index-CkiSD17h.js";import{S as v}from"./stats.min-BpIepu9J.js";const L=document.getElementById("container"),s=new h,C=s.get(f),e=C.create();e.scene=new g(s);e.renderer=new w(s,L);e.camera=new y(s);s.init();e.scene.three.background=null;const k=new l({color:"#6528D7"}),x=new c,A=new m(x,k);e.scene.three.add(A);e.scene.setup();e.camera.controls.setLookAt(3,3,3,0,0,0);const n=new v;n.showPanel(2);document.body.append(n.dom);n.dom.style.left="0px";n.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>n.begin());e.renderer.onAfterUpdate.add(()=>n.end());u.init();const i=a.create(()=>r`
