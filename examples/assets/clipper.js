import{B as r,M as m,a as p}from"./web-ifc-api-DEkz78xJ.js";import{S as d}from"./stats.min-BpIepu9J.js";import{p as u,J as s,m as c}from"./index-K5IA6oiZ.js";import{p as h,C as g,s as k,i as w,H as y,z as f,R as v}from"./index-BT4udTRq.js";const b=document.getElementById("container"),a=new h,M=a.get(g),e=M.create();e.scene=new k(a);e.renderer=new w(a,b);e.camera=new y(a);a.init();e.camera.controls.setLookAt(10,10,10,0,0,0);e.scene.setup();e.scene.three.background=null;const x=new r(3,3,3),$=new m({color:"#6528D7"}),o=new p(x,$);o.position.set(0,1.5,0);e.scene.three.add(o);e.meshes.add(o);const C=a.get(f);C.get(e);const t=a.get(v);t.enabled=!0;b.ondblclick=()=>{t.enabled&&t.create(e)};window.onkeydown=n=>{(n.code==="Delete"||n.code==="Backspace")&&t.enabled&&t.delete(e)};const l=new d;l.showPanel(2);document.body.append(l.dom);l.dom.style.left="0px";l.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>l.begin());e.renderer.onAfterUpdate.add(()=>l.end());u.init();const i=s.create(()=>c`
