import{B as r,b as m,M as p}from"./web-ifc-api-BffFJDIm.js";import{S as d}from"./stats.min-GTpOrGrX.js";import{p as u,a as s,m as c}from"./index-DyM33b1I.js";import{p as h,C as k,i as g,n as w,k as y,H as v,A as M}from"./index-D43g96vP.js";import"./_commonjsHelpers-Cpj98o6Y.js";const b=document.getElementById("container"),a=new h,x=a.get(k),e=x.create();e.scene=new g(a);e.renderer=new w(a,b);e.camera=new y(a);a.init();e.camera.controls.setLookAt(10,10,10,0,0,0);e.scene.setup();e.scene.three.background=null;const f=new r(3,3,3),$=new m({color:"#6528D7"}),l=new p(f,$);l.position.set(0,1.5,0);e.scene.three.add(l);e.meshes.add(l);const C=a.get(v);C.get(e);const t=a.get(M);t.enabled=!0;b.ondblclick=()=>t.create(e);window.onkeydown=n=>{(n.code==="Delete"||n.code==="Backspace")&&t.delete(e)};const o=new d;o.showPanel(2);document.body.append(o.dom);o.dom.style.left="0px";o.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>o.begin());e.renderer.onAfterUpdate.add(()=>o.end());u.init();const i=s.create(()=>c`
