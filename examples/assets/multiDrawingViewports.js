import{B as Z,E as me,q as K,r as be,aF as fe,t as ue,M as we,e as he,o as ge,l as ye,V as a,G as ve,L as xe,R as Ee,p as ke,m as J,a as g,b as Ce,j as Q,P as Se}from"./index-r1u2qk8S.js";import{T as Le,F as Pe}from"./FontLoader-BARhHCk1.js";import{C as Me,W as $e,S as Ae,a as Be,f as Re,F as ee}from"./index-Dx2GLmSS.js";import{T as Ve}from"./index-FkodYGyV.js";import{D as De}from"./index-WdMAYOcc.js";import{L as Fe}from"./index-CkNNPDGM.js";import"./index-BKAJsCnu.js";import"./three.tsl-BohoDV_b.js";import"./index-BSrNQ9Xt.js";import"./ticks-BXRbr5hg.js";import"./index-DeufLhcM.js";import"./index-DrkK79j1.js";document.body.style.cssText="margin:0; width:100vw; height:100vh; overflow:hidden; position:relative;";const k=new Me,Oe=k.get($e),m=Oe.create();m.scene=new Ae(k);m.scene.setup();m.scene.three.background=null;const V=document.getElementById("container");V.style.cssText="position:absolute; inset:0;";m.renderer=new Be(k,V);m.camera=new Re(k);await m.camera.controls.setLookAt(48.213,33.495,-5.062,13.117,-1.205,22.223);k.init();const ze=await ee.getWorker(),$=k.get(ee);$.init(ze);m.camera.controls.addEventListener("update",()=>$.core.update());$.list.onItemSet.add(({value:t})=>{t.useCamera(m.camera.three),m.scene.three.add(t.object),$.core.update(!0)});$.core.models.materials.list.onItemSet.add(({value:t})=>{"isLodMaterial"in t&&t.isLodMaterial||(t.polygonOffset=!0,t.polygonOffsetUnits=1,t.polygonOffsetFactor=Math.random())});const Te=await fetch("https://thatopen.github.io/engine_components/resources/frags/school_arq.frag"),_e=await Te.arrayBuffer();await $.core.load(_e,{modelId:"school_arq"});const te=k.get(Ve),r=te.create(m);r.three.position.y=11.427046;const je=await fetch("https://thatopen.github.io/engine_components/resources/projections/projection.json").then(t=>t.json()),oe=new Z;oe.setAttribute("position",new me(new Float32Array(je.positions),3));r.layers.create("projection",{material:new K({color:16711680})});const Ue=new be(oe);r.addProjectionLines(Ue,"projection");const O=r.viewports.create({left:-.996,right:16.493,top:-57.877,bottom:-64.375,scale:100}),z=r.viewports.create({left:-5.04,right:-1.434,top:.568,bottom:-5.934,scale:100});O.helperVisible=!0;z.helperVisible=!0;O.helper.resizable=!0;O.helper.movable=!0;z.helper.resizable=!0;z.helper.movable=!0;const U=40,H=16,M=20,A=document.createElement("div");A.style.cssText=`
  position: absolute;
  bottom: 24px;
  left: 24px;
