import{B as Z,y as pe,o as K,q as me,aL as be,s as fe,M as ue,e as we,D as he,l as ge,V as a,G as ye,L as ve,R as xe,P as Ee,p as ke,m as J,a as g,b as Ce,j as Q}from"./index-BTQc5iy9.js";import{T as Se,F as Le}from"./FontLoader-D_WZeVFu.js";import{C as Pe,W as Me,S as $e,a as Ae,f as Be,F as Re}from"./index-D0VJ-jrh.js";import{T as Ve}from"./index-BysDHYAc.js";import{D as De}from"./index-Yrc9xccx.js";import{L as Fe}from"./index-CpyjxNHB.js";import"./index-DclDBJIN.js";import"./three.tsl-Dohe8Dnx.js";import"./index-BPJgOurm.js";import"./ticks-C1CNaVZj.js";import"./index-p95DX9i3.js";import"./index-BP-SUA70.js";document.body.style.cssText="margin:0; width:100vw; height:100vh; overflow:hidden; position:relative;";const k=new Pe,Oe=k.get(Me),m=Oe.create();m.scene=new $e(k);m.scene.setup();m.scene.three.background=null;const V=document.getElementById("container");V.style.cssText="position:absolute; inset:0;";m.renderer=new Ae(k,V);m.camera=new Be(k);await m.camera.controls.setLookAt(48.213,33.495,-5.062,13.117,-1.205,22.223);k.init();const je="https://thatopen.github.io/engine_fragment/resources/worker.mjs",Ue=await fetch(je),ze=await Ue.blob(),Te=new File([ze],"worker.mjs",{type:"text/javascript"}),_e=URL.createObjectURL(Te),$=k.get(Re);$.init(_e);m.camera.controls.addEventListener("update",()=>$.core.update());$.list.onItemSet.add(({value:t})=>{t.useCamera(m.camera.three),m.scene.three.add(t.object),$.core.update(!0)});$.core.models.materials.list.onItemSet.add(({value:t})=>{"isLodMaterial"in t&&t.isLodMaterial||(t.polygonOffset=!0,t.polygonOffsetUnits=1,t.polygonOffsetFactor=Math.random())});const Ie=await fetch("https://thatopen.github.io/engine_components/resources/frags/school_arq.frag"),Ge=await Ie.arrayBuffer();await $.core.load(Ge,{modelId:"school_arq"});const ee=k.get(Ve),r=ee.create(m);r.three.position.y=11.427046;const We=await fetch("https://thatopen.github.io/engine_components/resources/projections/projection.json").then(t=>t.json()),te=new Z;te.setAttribute("position",new pe(new Float32Array(We.positions),3));r.layers.create("projection",{material:new K({color:16711680})});const Xe=new me(te);r.addProjectionLines(Xe,"projection");const O=r.viewports.create({left:-.996,right:16.493,top:-57.877,bottom:-64.375,scale:100}),j=r.viewports.create({left:-5.04,right:-1.434,top:.568,bottom:-5.934,scale:100});O.helperVisible=!0;j.helperVisible=!0;O.helper.resizable=!0;O.helper.movable=!0;j.helper.resizable=!0;j.helper.movable=!0;const _=40,H=16,M=20,A=document.createElement("div");A.style.cssText=`
  position: absolute;
  bottom: 24px;
  left: 24px;
