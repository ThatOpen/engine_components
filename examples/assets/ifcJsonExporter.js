import{k as d}from"./web-ifc-api-CuDRTh9k.js";import{S as f}from"./stats.min-GTpOrGrX.js";import{T as b,L as i,m as c}from"./index-C8nqhRYO.js";import{C as u,W as g,S as w,d as h,a as y,G as S,F as L,j as k}from"./index-MG2l5tzA.js";import"./_commonjsHelpers-Cpj98o6Y.js";const x=document.getElementById("container"),t=new u,I=t.get(g),e=I.create();e.scene=new w(t);e.renderer=new h(t,x);e.camera=new y(t);t.init();e.camera.controls.setLookAt(12,6,8,0,0,-10);e.scene.setup();const U=t.get(S);U.create(e);e.scene.three.background=null;const v=new L(t),B=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),F=await B.arrayBuffer(),O=new Uint8Array(F),j=v.load(O);e.scene.three.add(j);const A=t.get(k),a=new d;a.SetWasmPath("https://unpkg.com/web-ifc@0.0.66/",!0);await a.Init();const C=await fetch("https://thatopen.github.io/engine_components/resources/small.ifc"),E=await C.arrayBuffer(),R=new Uint8Array(E),J=a.OpenModel(R),n=new f;n.showPanel(2);document.body.append(n.dom);n.dom.style.left="0px";n.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>n.begin());e.renderer.onAfterUpdate.add(()=>n.end());b.init();const s=i.create(()=>c`
