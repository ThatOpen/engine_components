import{B as p,M as u,a as b,C as h}from"./web-ifc-api-CwSt8Jc1.js";import{p as w,C as f,s as g,H as x,d as v}from"./index-DPXwPaYJ.js";import{S}from"./stats.min-BpIepu9J.js";import{p as y,J as c,m as d}from"./index-K5IA6oiZ.js";import{U as $,f as C}from"./index-DGnK434s.js";const l=document.getElementById("container"),o=new w,E=o.get(f),e=E.create();e.scene=new g(o);e.renderer=new $(o,l);e.camera=new x(o);e.scene.setup();o.init();e.camera.controls.setLookAt(5,5,5,0,0,0);l.appendChild(e.renderer.three2D.domElement);const m=o.get(v);m.config.color.setHex(14540253);m.create(e);const M=new p(3,3,3),B=new u({color:"#6528D7"}),n=new b(M,B);n.position.set(0,1.5,0);e.scene.three.add(n);e.meshes.add(n);e.scene.three.background=new h("white");const t=o.get(C);t.shadowExtraScaleFactor=15;t.shadowOffset=.1;const a="example";t.create([n],a,e);const s=new S;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());y.init();const i=c.create(()=>d`
