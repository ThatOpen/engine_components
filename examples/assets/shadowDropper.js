import{B as m,M as p,a as u,C as b}from"./web-ifc-api-Df2dhA4n.js";import{C as h,T as w,e as f,x as g,y as x}from"./index-CC2Loeen.js";import{S as v}from"./stats.min-GTpOrGrX.js";import{T as S,z as c,m as d}from"./index-DtbylpTq.js";import{r as y,i as $}from"./index-CQOV9xGw.js";import"./_commonjsHelpers-Cpj98o6Y.js";const l=document.getElementById("container"),o=new h,C=o.get(w),e=C.create();e.scene=new f(o);e.renderer=new y(o,l);e.camera=new g(o);e.scene.setup();o.init();e.camera.controls.setLookAt(5,5,5,0,0,0);l.appendChild(e.renderer.three2D.domElement);const E=o.get(x),M=E.create(e);M.config.color.setHex(14540253);const T=new m(3,3,3),B=new p({color:"#6528D7"}),n=new u(T,B);n.position.set(0,1.5,0);e.scene.three.add(n);e.meshes.add(n);e.scene.three.background=new b("white");const t=o.get($);t.shadowExtraScaleFactor=15;t.shadowOffset=.1;const a="example";t.create([n],a,e);const s=new v;s.showPanel(2);document.body.append(s.dom);s.dom.style.left="0px";s.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>s.begin());e.renderer.onAfterUpdate.add(()=>s.end());S.init();const i=c.create(()=>d`
