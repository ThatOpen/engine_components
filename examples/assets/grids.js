import{a as c,B as l,b as m,C as b}from"./web-ifc-api-B6ue9hUU.js";import{S as d}from"./stats.min-CtzdRBYU.js";import{C as p,T as u,e as g,m as h,x as y,y as f}from"./index-BVVn3bHk.js";import{T as w,z as a,m as r}from"./index-DtbylpTq.js";const v=document.getElementById("container"),o=new p,x=o.get(u),e=x.create();e.scene=new g(o);e.renderer=new h(o,v);e.camera=new y(o);o.init();const z=new c(new l,new m({color:"red"}));e.scene.three.add(z);e.scene.three.background=null;const C=o.get(f),i=C.create(e);console.log(i);w.init();const t=a.create(()=>r`
