      ...
      <bim-panel-section label="Layers">
        ${[...n.layers].map(([e,o])=>k`
          <div style="display:flex; flex-direction:row; gap:0.5rem; justify-content:space-between;">
            ...
            <bim-dropdown
              style="max-width:fit-content"
              @change=${a=>{const f=a.target.value[0]==="dashed",g=o.material.color.getHex(),S=f?new x({color:g,dashSize:.3,gapSize:.2}):new h({color:g});n.layers.setMaterial(e,S),f&&n.three.traverse(u=>{u.userData.layer===e&&u.isLineSegments&&u.computeLineDistances()}),l()}}>
