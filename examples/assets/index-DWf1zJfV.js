 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const As={ATTRIBUTE:1,CHILD:2},Es=e=>(...t)=>({_$litDirective$:e,values:t});let Ss=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`).map(i=>i.trim()).map(i=>i.split('"')[1]).filter(i=>i!==void 0).flatMap(i=>i.split(/\s+/));return[...new Set(t)].filter(i=>i!=="")}firstUpdated(){this._onLayoutChange=new Event("layoutchange")}render(){if(this.layout){if(this.layouts[this.layout]){this.innerHTML="";const e=this.layouts[this.layout],t=this.getUniqueAreasFromTemplate(e.template).map(i=>{const n=e.elements[i];return n&&(n.style.gridArea=i),n}).filter(i=>!!i);this.style.gridTemplate=e.template,this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange),this.append(...t)}}else this.innerHTML="",this.style.gridTemplate="",this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange);return m`<slot></slot>`}};or.styles=N`
  ...
  `;let Pn=or;nr([g({type:Boolean,reflect:!0})],Pn.prototype,"floating");nr([g({type:String,reflect:!0})],Pn.prototype,"layout");const bn=class extends O{render(){return m`
  ...
  `;let br=fr;nd([g({type:Boolean,attribute:"children-hidden",reflect:!0})],br.prototype,"childrenHidden");var od=Object.defineProperty,ve=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&od(t,i,o),o};const gr=class extends O{constructor(){super(...arguments),this.selected=!1,this.columns=[],this.hiddenColumns=[],this.data={},this.isHeader=!1,this.table=this.closest("bim-table"),this.onTableColumnsChange=()=>{this.table&&(this.columns=this.table.columns)},this.onTableColumnsHidden=()=>{this.table&&(this.hiddenColumns=this.table.hiddenColumns)},this._observer=new IntersectionObserver(e=>{this._intersecting=e[0].isIntersecting},{rootMargin:"36px"})}get _columnNames(){return this.columns.filter(e=>!this.hiddenColumns.includes(e.name)).map(e=>e.name)}get _columnWidths(){return this.columns.filter(e=>!this.hiddenColumns.includes(e.name)).map(e=>e.width)}get _isSelected(){var e;return(e=this.table)==null?void 0:e.selection.has(this.data)}onSelectionChange(e){if(!this.table)return;const t=e.target;this.selected=t.value,t.value?(this.table.selection.add(this.data),this.table.dispatchEvent(new CustomEvent("rowselected",{detail:{data:this.data}}))):(this.table.selection.delete(this.data),this.table.dispatchEvent(new CustomEvent("rowdeselected",{detail:{data:this.data}})))}connectedCallback(){super.connectedCallback(),this._observer.observe(this),this.table&&(this.columns=this.table.columns,this.hiddenColumns=this.table.hiddenColumns,this.table.addEventListener("columnschange",this.onTableColumnsChange),this.table.addEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",this._isSelected))}disconnectedCallback(){super.disconnectedCallback(),this._observer.unobserve(this),this.table&&(this.columns=[],this.hiddenColumns=[],this.table.removeEventListener("columnschange",this.onTableColumnsChange),this.table.removeEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",!1))}compute(){if(!this.table)throw new Error("TableRow: parent table wasn't found!");const e=this.table.getRowIndentation(this.data)??0,t=this.isHeader?this.data:this.table.applyDataTransform(this.data)??this.data,i=[];for(const n in t){if(this.hiddenColumns.includes(n))continue;const o=t[n];let s;if(typeof o=="string"||typeof o=="boolean"||typeof o=="number"?(s=document.createElement("bim-label"),s.textContent=String(o)):o instanceof HTMLElement?s=o:(s=document.createDocumentFragment(),se(o,s)),!s)continue;const r=document.createElement("bim-table-cell");r.append(s),r.column=n,this._columnNames.indexOf(n)===0&&(r.style.marginLeft=`${this.table.noIndentation?0:e+.75}rem`);const l=this._columnNames.indexOf(n);r.setAttribute("data-column-index",String(l)),r.toggleAttribute("data-no-indentation",l===0&&this.table.noIndentation),r.toggleAttribute("data-cell-header",this.isHeader),r.rowData=this.data,this.table.dispatchEvent(new CustomEvent("cellcreated",{detail:{cell:r}})),i.push(r)}return this.style.gridTemplateAreas=`"${this.table.selectableRows?"Selection":""} ${this._columnNames.join(" ")}"`,this.style.gridTemplateColumns=`${this.table.selectableRows?"1.6rem":""} ${this._columnWidths.join(" ")}`,m`
      ...
      ${i}
      <slot></slot>
    `}render(){return m`${this._intersecting?this.compute():m``}`}};gr.styles=N`
    :host {
      position: relative;
      grid-area: Data;
      display: grid;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const To=e=>e??R;var ud=Object.defineProperty,hd=Object.getOwnPropertyDescriptor,gt=(e,t,i,n)=>{for(var o=n>1?void 0:n?hd(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ud(t,i,o),o};const $r=class extends O{constructor(){super(...arguments),this._inputTypes=["date","datetime-local","email","month","password","search","tel","text","time","url","week","area"],this.value="",this.vertical=!1,this._type="text",this.onValueChange=new Event("input")}set type(e){this._inputTypes.includes(e)&&(this._type=e)}get type(){return this._type}get query(){return mn(this.value)}onInputChange(e){e.stopPropagation();const t=e.target;clearTimeout(this._debounceTimeoutID),this._debounceTimeoutID=setTimeout(()=>{this.value=t.value,this.dispatchEvent(this.onValueChange)},this.debounce)}focus(){setTimeout(()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()})}render(){return m`
      <bim-input
        .name=${this.name}
        .icon=${this.icon}
        .label=${this.label}
  ...
  `;let _e=Cr;Bi([g({type:String,reflect:!0})],_e.prototype,"label",2);Bi([g({type:String,reflect:!0})],_e.prototype,"icon",2);Bi([g({type:Boolean,reflect:!0})],_e.prototype,"vertical",1);Bi([g({type:Boolean,attribute:"label-hidden",reflect:!0})],_e.prototype,"labelHidden",1);var gd=Object.defineProperty,vd=Object.getOwnPropertyDescriptor,Rn=(e,t,i,n)=>{for(var o=n>1?void 0:n?vd(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&gd(t,i,o),o};const Ar=class extends O{constructor(){super(...arguments),this.labelsHidden=!1,this._vertical=!1,this._hidden=!1}set vertical(e){this._vertical=e,this.updateSections()}get vertical(){return this._vertical}set hidden(e){this._hidden=e,this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}updateSections(){const e=this.children;for(const t of e)t instanceof _e&&(t.labelHidden=this.vertical&&!W.config.sectionLabelOnVerticalToolbar,t.vertical=this.vertical)}render(){return m`
      <div class="parent">
  ...
  `;let Ui=Ar;Rn([g({type:String,reflect:!0})],Ui.prototype,"icon",2);Rn([g({type:Boolean,attribute:"labels-hidden",reflect:!0})],Ui.prototype,"labelsHidden",2);Rn([g({type:Boolean,reflect:!0})],Ui.prototype,"vertical",1);var yd=Object.defineProperty,_d=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&yd(t,i,o),o};const Er=class extends O{constructor(){super(),this._onResize=new Event("resize"),new ResizeObserver(()=>{setTimeout(()=>{this.dispatchEvent(this._onResize)})}).observe(this)}render(){return m`
      <div class="parent">
        <slot></slot>
      </div>
    `}};Er.styles=N`
 ...
 */const kr="important",$d=" !"+kr,zt=Es(class extends Ss{constructor(e){var t;if(super(e),e.type!==As.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const n=e[i];return n==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const n of this.ft)t[n]==null&&(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in t){const o=t[n];if(o!=null){this.ft.add(n);const s=typeof o=="string"&&o.endsWith($d);n.includes("-")||s?i.setProperty(n,s?o.slice(0,-11):o,s?kr:""):i[n]=o}}return Bt}}),xd=e=>{const{components:t}=e,i=t.get(Qr);return m`
  ...
  `},wd=e=>U.create(xd,e),Cd=Object.freeze(Object.defineProperty({__proto__:null,loadIfc:wd},Symbol.toStringTag,{value:"Module"}));({...Cd});const Ad=e=>{const{components:t,actions:i,tags:n}=e,o=(i==null?void 0:i.dispose)??!0,s=(i==null?void 0:i.download)??!0,r=(i==null?void 0:i.visibility)??!0,l=(n==null?void 0:n.schema)??!0,a=(n==null?void 0:n.viewDefinition)??!0,d=t.get(Vt),u=({detail:c})=>{const{cell:h}=c;h.style.padding="0.25rem 0"};return m`
    <bim-table ${q(c=>{if(!c)return;const h=c;h.hiddenColumns=["modelID"];const p=[];for(const[,b]of d.groups){if(!b)continue;const $={data:{Name:b.name||b.uuid,modelID:b.uuid}};p.push($)}h.dataTransform={Name:(b,$)=>{const{modelID:v}=$;if(typeof v!="string")return b;const f=d.groups.get(v);if(!f)return v;const y={};for(const S of f.items)y[S.id]=S.ids;let _;const{schema:x}=f.ifcMetadata;l&&x&&(_=m`
          ...
          `}let C;o&&(C=m`<bim-button @click=${()=>d.disposeGroup(f)} icon="mdi:delete"></bim-button>`);let T;r&&(T=m`<bim-button @click=${S=>{const E=t.get(Go),F=S.target;E.set(F.hasAttribute("data-model-hidden"),y),F.toggleAttribute("data-model-hidden"),F.icon=F.hasAttribute("data-model-hidden")?"mdi:eye-off":"mdi:eye"}} icon="mdi:eye"></bim-button>`);let M;return s&&(M=m`<bim-button @click=${()=>{const S=document.createElement("input");S.type="file",S.accept=".ifc",S.multiple=!1,S.addEventListener("change",async()=>{if(!(S.files&&S.files.length===1))return;const E=S.files[0],F=await E.arrayBuffer(),Y=await t.get(ta).saveToIfc(f,new Uint8Array(F)),G=new File([Y],E.name),w=document.createElement("a");w.href=URL.createObjectURL(G),w.download=G.name,w.click(),URL.revokeObjectURL(w.href)}),S.click()}} icon="flowbite:download-solid"></bim-button>`),m`
  ...
  `},Yd=e=>U.create(qd,e),Xd=Object.freeze(Object.defineProperty({__proto__:null,elementProperties:Yd},Symbol.toStringTag,{value:"Module"})),gn=async(e,t,i,n)=>{var o;const s=[],r=e.get(ht),l=await t.getProperties(i);if(!l)return s;const{type:a}=l,d={data:{Entity:mi[a],Name:(o=l.Name)==null?void 0:o.value,modelID:t.uuid,expressID:i}};for(const u of n){const c=r.getEntityRelations(t,i,u);if(!c)continue;d.children||(d.children=[]),d.data.relations=JSON.stringify(c);const h={};for(const p of c){const b=await gn(e,t,p,n);for(const $ of b)if($.data.relations)d.children.push($);else{const v=t.data.get(p);if(!v){d.children.push($);continue}const f=v[1][1],y=mi[f];y in h||(h[y]=[]),$.data.Entity=$.data.Name,delete $.data.Name,h[y].push($)}}for(const p in h){const b=h[p],$=b.map(f=>f.data.expressID),v={data:{Entity:p,modelID:t.uuid,relations:JSON.stringify($)},children:b};d.children.push(v)}}return s.push(d),s},Jd=async(e,t,i,n)=>{const o=e.get(ht),s=[];for(const r of t){let l;if(n)l={data:{Entity:r.name!==""?r.name:r.uuid},children:await gn(e,r,n,i)};else{const a=o.relationMaps[r.uuid],d=await r.getAllPropertiesOfType(na);if(!(a&&d))continue;const{expressID:u}=Object.values(d)[0];l={data:{Entity:r.name!==""?r.name:r.uuid},children:await gn(e,r,u,i)}}s.push(l)}return s};let pt;const Qd=(e,t)=>{const i=e.get(Vt),{modelID:n,expressID:o,relations:s}=t;if(!n)return null;const r=i.groups.get(n);return r?r.getFragmentMap([o,...JSON.parse(s??"[]")]):null},Zd=e=>{const{components:t,models:i,expressID:n}=e,o=e.selectHighlighterName??"select",s=e.hoverHighlighterName??"hover";pt||(pt=document.createElement("bim-table"),pt.hiddenColumns=["modelID","expressID","relations"],pt.columns=["Entity","Name"],pt.headersHidden=!0,pt.addEventListener("cellcreated",({detail:l})=>{const{cell:a}=l;a.column==="Entity"&&!("Name"in a.rowData)&&(a.style.gridColumn="1 / -1")})),pt.addEventListener("rowcreated",l=>{l.stopImmediatePropagation();const{row:a}=l.detail,d=t.get(ba),u=Qd(t,a.data);u&&Object.keys(u).length!==0&&(a.onmouseover=()=>{s&&(a.style.backgroundColor="var(--bim-ui_bg-contrast-20)",d.highlightByID(s,u,!0,!1,d.selection[o]??{}))},a.onmouseout=()=>{a.style.backgroundColor="",d.clear(s)},a.onclick=()=>{o&&d.highlightByID(o,u,!0,!0)})});const r=e.inverseAttributes??["IsDecomposedBy","ContainsElements"];return Jd(t,i,r,n).then(l=>pt.data=l),m`${pt}`},Kd=(e,t=!0)=>{const i=U.create(Zd,e);if(t){const[,n]=i,{components:o}=e,s=o.get(Vt),r=o.get(ht),l=()=>n({models:s.groups.values()});r.onRelationsIndexed.add(l),s.onFragmentsDisposed.add(l)}return i},tu=Object.freeze(Object.defineProperty({__proto__:null,relationsTree:Kd},Symbol.toStringTag,{value:"Module"})),Se=(e,t)=>[...e.get(Wo).list.values()].find(i=>i.world===t),eu=(e,t)=>m`
  ...
  `,I=(e,t,i,n)=>{const o={slider:!1,min:0,max:100,step:1,prefix:null,suffix:null,onInputSet:()=>{},...n},{slider:s,min:r,max:l,step:a,suffix:d,prefix:u,onInputSet:c}=o;return m`
    ...
    ></bim-number-input> 
  `},lu=e=>{const{components:t}=e,i=t.get(Oi);return m`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xu={CHILD:2},wu=e=>(...t)=>({_$litDirective$:e,values:t});let Cu=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const vn=()=>new Ou;let Ou=class{};const tn=new WeakMap,Tu=wu(class extends ku{render(e){return j}update(e,[t]){var i;const n=t!==this.Y;return n&&this.Y!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.Y=t,this.ht=(i=e.options)==null?void 0:i.host,this.rt(this.ct=e.element)),j}rt(e){if(this.isConnected||(e=void 0),typeof this.Y=="function"){const t=this.ht??globalThis;let i=tn.get(t);i===void 0&&(i=new WeakMap,tn.set(t,i)),i.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),i.set(this.Y,e),e!==void 0&&this.Y.call(this.ht,e)}else this.Y.value=e}get lt(){var e,t;return typeof this.Y=="function"?(e=tn.get(this.ht??globalThis))==null?void 0:e.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Nu={dueDate:e=>{if(typeof e=="string"&&e.trim()!=="")return new Date(e)},status:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},type:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},priority:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},stage:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},assignedTo:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},labels:e=>{if(Array.isArray(e))return new Set(e)}},zr=e=>{const{components:t,topic:i,value:n,onCancel:o,onSubmit:s,styles:r}=e,l=s??(()=>{}),a=t.get(ki),d=(n==null?void 0:n.title)??(i==null?void 0:i.title)??yt.default.title,u=(n==null?void 0:n.status)??(i==null?void 0:i.status)??yt.default.status,c=(n==null?void 0:n.type)??(i==null?void 0:i.type)??yt.default.type,h=(n==null?void 0:n.priority)??(i==null?void 0:i.priority)??yt.default.priority,p=(n==null?void 0:n.assignedTo)??(i==null?void 0:i.assignedTo)??yt.default.assignedTo,b=(n==null?void 0:n.labels)??(i==null?void 0:i.labels)??yt.default.labels,$=(n==null?void 0:n.stage)??(i==null?void 0:i.stage)??yt.default.stage,v=(n==null?void 0:n.description)??(i==null?void 0:i.description)??yt.default.description,f=i!=null&&i.dueDate?i.dueDate.toISOString().split("T")[0]:null,y=new Set([...a.config.statuses]);u&&y.add(u);const _=new Set([...a.config.types]);c&&_.add(c);const x=new Set([...a.config.priorities]);h&&x.add(h);const A=new Set([...a.config.users]);p&&A.add(p);const C=new Set([...a.config.labels]);if(b)for(const w of b)C.add(w);const T=new Set([...a.config.stages]);$&&T.add($);const M=vn(),S=async()=>{const{value:w}=M;if(!w)return;const L=Be(w,Nu);if(i)i.set(L),await l(i);else{const V=a.create(L);await l(V)}},E=vn(),F=w=>{const{value:L}=E;if(!L)return;const V=w.target;L.disabled=V.value.trim()===""},Y=`btn-${W.newRandomId()}`,G=`btn-${W.newRandomId()}`;return m`
  ...
  `},Iu=e=>{const{components:t,dataStyles:i,onTopicEnter:n}=e,o=t.get(ki),s=e.topics??o.list.values();return m`
  ...
  `},Dr=(e,t=!0)=>{const i=U.create(Iu,e);if(t){const{components:n,topics:o}=e,[,s]=i,r=n.get(ki);if(r.list.onItemUpdated.add(()=>s()),r.list.onItemDeleted.add(()=>s()),o)for(const l of o)l.relatedTopics.onItemAdded.add(()=>s()),l.relatedTopics.onItemDeleted.add(()=>s()),l.relatedTopics.onCleared.add(()=>s());else r.list.onItemSet.add(()=>s())}return i},Mu=Object.freeze(Object.defineProperty({__proto__:null,topicsList:Dr},Symbol.toStringTag,{value:"Module"})),Pu=e=>{const{topic:t,styles:i,viewpoint:n}=e,o={delete:!0,...e.actions};return m`
  ...
  `},Hr=(e,t=!0)=>{const i=U.create(Pu,e);if(t){const{topic:n}=e,[o,s]=i;n.comments.onItemSet.add(()=>s()),n.comments.onItemUpdated.add(()=>s()),n.comments.onItemDeleted.add(()=>s()),n.comments.onCleared.add(()=>s())}return i},Ru=Object.freeze(Object.defineProperty({__proto__:null,topicComments:Hr},Symbol.toStringTag,{value:"Module"})),Lu=e=>{var t;const{components:i,topic:n}=e,o={selectComponents:!0,colorizeComponent:!0,resetColors:!0,updateCamera:!0,delete:!0,unlink:!!n,...e.actions},s=i.get(yn),r=((t=e.topic)==null?void 0:t.viewpoints)??s.list.keys(),l=[];for(const a of r){const d=s.list.get(a);d&&l.push(d)}return m`
 ...
 */function dh(e){return X({...e,state:!0,attribute:!1})}class uh extends ha{constructor(t=document.createElement("div")){super(),this.isCSS2DObject=!0,this.element=t,this.element.style.position="absolute",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.center=new pa(.5,.5),this.addEventListener("removed",function(){this.traverse(function(i){i.element instanceof Element&&i.element.parentNode!==null&&i.element.parentNode.removeChild(i.element)})})}copy(t,i){return super.copy(t,i),this.element=t.element.cloneNode(!0),this.center=t.center,this}}new _n;new Ti;new Ti;new _n;new _n;class hh{constructor(t,i){this._group=new Bn,this._frustum=new da,this._frustumMat=new Ti,this._regenerateDelay=200,this._regenerateCounter=0,this.material=new ua({color:"#2e3338"}),this.numbers=new Bn,this.maxRegenerateRetrys=4,this.gridsFactor=5,this._scaleX=1,this._scaleY=1,this._offsetX=0,this._offsetY=0,this._camera=t,this._container=i;const n=this.newGrid(-1),o=this.newGrid(-2);this.grids={main:n,secondary:o},this._group.add(o,n,this.numbers)}set scaleX(t){this._scaleX=t,this.regenerate()}get scaleX(){return this._scaleX}set scaleY(t){this._scaleY=t,this.regenerate()}get scaleY(){return this._scaleY}set offsetX(t){this._offsetX=t,this.regenerate()}get offsetX(){return this._offsetX}set offsetY(t){this._offsetY=t,this.regenerate()}get offsetY(){return this._offsetY}get(){return this._group}dispose(){const{main:t,secondary:i}=this.grids;t.removeFromParent(),i.removeFromParent(),t.geometry.dispose(),t.material.dispose(),i.geometry.dispose(),i.material.dispose()}regenerate(){if(!this.isGridReady()){if(this._regenerateCounter++,this._regenerateCounter>this.maxRegenerateRetrys)throw new Error("Grid could not be regenerated");setTimeout(()=>this.regenerate,this._regenerateDelay);return}this._regenerateCounter=0,this._camera.updateMatrix(),this._camera.updateMatrixWorld();const t=this._frustumMat.multiplyMatrices(this._camera.projectionMatrix,this._camera.matrixWorldInverse);this._frustum.setFromProjectionMatrix(t);const{planes:i}=this._frustum,n=i[0].constant*-i[0].normal.x,o=i[1].constant*-i[1].normal.x,s=i[2].constant*-i[2].normal.y,r=i[3].constant*-i[3].normal.y,l=Math.abs(n-o),a=Math.abs(r-s),{clientWidth:d,clientHeight:u}=this._container,c=Math.max(d,u),h=Math.max(l,a)/c,p=Math.ceil(Math.log10(l/this.scaleX)),b=Math.ceil(Math.log10(a/this.scaleY)),$=10**(p-2)*this.scaleX,v=10**(b-2)*this.scaleY,f=$*this.gridsFactor,y=v*this.gridsFactor,_=Math.ceil(a/y),x=Math.ceil(l/f),A=Math.ceil(a/v),C=Math.ceil(l/$),T=$*Math.ceil(o/$),M=v*Math.ceil(s/v),S=f*Math.ceil(o/f),E=y*Math.ceil(s/y),F=[...this.numbers.children];for(const B of F)B.removeFromParent();this.numbers.children=[];const Y=[],G=9*h,w=1e4,L=S+this._offsetX,V=Math.round(Math.abs(L/this.scaleX)*w)/w,K=(x-1)*f,tt=Math.round(Math.abs((L+K)/this.scaleX)*w)/w,ct=Math.max(V,tt).toString().length*G;let xe=Math.ceil(ct/f)*f;for(let B=0;B<x;B++){let z=S+B*f;Y.push(z,r,0,z,s,0),z=Math.round(z*w)/w,xe=Math.round(xe*w)/w;const we=z%xe;if(!(f<1||y<1)&&Math.abs(we)>.01)continue;const si=this.newNumber((z+this._offsetX)/this.scaleX),Gi=12*h;si.position.set(z,s+Gi,0)}for(let B=0;B<_;B++){const z=E+B*y;Y.push(o,z,0,n,z,0);const we=this.newNumber(z/this.scaleY);let si=12;we.element.textContent&&(si+=4*we.element.textContent.length);const Gi=si*h;we.position.set(o+Gi,z,0)}const Wi=[];for(let B=0;B<C;B++){const z=T+B*$;Wi.push(z,r,0,z,s,0)}for(let B=0;B<A;B++){const z=M+B*v;Wi.push(o,z,0,n,z,0)}const qr=new Un(new Float32Array(Y),3),Yr=new Un(new Float32Array(Wi),3),{main:Xr,secondary:Jr}=this.grids;Xr.geometry.setAttribute("position",qr),Jr.geometry.setAttribute("position",Yr)}newNumber(t){const i=document.createElement("bim-label");i.textContent=String(Math.round(t*100)/100);const n=new uh(i);return this.numbers.add(n),n}newGrid(t){const i=new ma,n=new fa(i,this.material);return n.frustumCulled=!1,n.renderOrder=t,n}isGridReady(){const t=this._camera.projectionMatrix.elements;for(let i=0;i<t.length;i++){const n=t[i];if(Number.isNaN(n))return!1}return!0}}var ph=Object.defineProperty,mh=Object.getOwnPropertyDescriptor,oi=(e,t,i,n)=>{for(var o=mh(t,i),s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&ph(t,i,o),o};const Ur=class extends Dt{constructor(){super(...arguments),this._grid=null,this._world=null,this.resize=()=>{this._world&&this._grid&&this._grid.regenerate()}}set gridColor(t){if(this._gridColor=t,!(t&&this._grid))return;const i=Number(t.replace("#","0x"));Number.isNaN(i)||this._grid.material.color.setHex(i)}get gridColor(){return this._gridColor}set gridScaleX(t){this._gridScaleX=t,t&&this._grid&&(this._grid.scaleX=t)}get gridScaleX(){return this._gridScaleX}set gridScaleY(t){this._gridScaleY=t,t&&this._grid&&(this._grid.scaleY=t)}get gridScaleY(){return this._gridScaleY}get gridOffsetX(){var t;return((t=this._grid)==null?void 0:t.offsetX)||0}set gridOffsetX(t){this._grid&&(this._grid.offsetX=t)}get gridOffsetY(){var t;return((t=this._grid)==null?void 0:t.offsetY)||0}set gridOffsetY(t){this._grid&&(this._grid.offsetY=t)}set components(t){this.dispose();const i=t.get(Oi).create();this._world=i,i.scene=new qo(t),i.scene.setup(),i.renderer=new ga(t,this);const n=new Yo(t);i.camera=n;const o=new hh(n.threeOrtho,this);this._grid=o,i.scene.three.add(o.get()),n.controls.addEventListener("update",()=>o.regenerate()),setTimeout(async()=>{i.camera.updateAspect(),n.set("Plan"),await n.controls.setLookAt(0,0,100,0,0,0),await n.projection.set("Orthographic"),n.controls.dollySpeed=3,n.controls.draggingSmoothTime=.085,n.controls.maxZoom=1e3,n.controls.zoom(4)})}get world(){return this._world}dispose(){var t;(t=this.world)==null||t.dispose(),this._world=null,this._grid=null}connectedCallback(){super.connectedCallback(),new ResizeObserver(this.resize).observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.dispose()}render(){return jn`<slot></slot>`}};Ur.styles=Hn`
  ...
  `;let $e=Ur;oi([X({type:String,attribute:"grid-color",reflect:!0})],$e.prototype,"gridColor");oi([X({type:Number,attribute:"grid-scale-x",reflect:!0})],$e.prototype,"gridScaleX");oi([X({type:Number,attribute:"grid-scale-y",reflect:!0})],$e.prototype,"gridScaleY");oi([X({type:Number,attribute:"grid-offset-x",reflect:!0})],$e.prototype,"gridOffsetX");oi([X({type:Number,attribute:"grid-offset-y",reflect:!0})],$e.prototype,"gridOffsetY");var fh=Object.defineProperty,Nt=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&fh(t,i,o),o};const Vr=class extends Dt{constructor(){super(...arguments),this._defaults={size:60},this._cssMatrix3D="",this._matrix=new Ti,this._onRightClick=new Event("rightclick"),this._onLeftClick=new Event("leftclick"),this._onTopClick=new Event("topclick"),this._onBottomClick=new Event("bottomclick"),this._onFrontClick=new Event("frontclick"),this._onBackClick=new Event("backclick"),this._camera=null,this._epsilon=t=>Math.abs(t)<1e-10?0:t}set camera(t){this._camera=t,this.updateOrientation()}get camera(){return this._camera}updateOrientation(){if(!this.camera)return;this._matrix.extractRotation(this.camera.matrixWorldInverse);const{elements:t}=this._matrix;this._cssMatrix3D=`matrix3d(
      ${this._epsilon(t[0])},
      ${this._epsilon(-t[1])},
      ${this._epsilon(t[2])},
      ${this._epsilon(t[3])},
      ...
      ${this._epsilon(t[14])},
      ${this._epsilon(t[15])})
    `}render(){const t=this.size??this._defaults.size;return jn`
      <style>
        .face,
        .cube {
          width: ${t}px;
  ...
  `;let vt=Vr;Nt([X({type:Number,reflect:!0})],vt.prototype,"size");Nt([X({type:String,attribute:"right-text",reflect:!0})],vt.prototype,"rightText");Nt([X({type:String,attribute:"left-text",reflect:!0})],vt.prototype,"leftText");Nt([X({type:String,attribute:"top-text",reflect:!0})],vt.prototype,"topText");Nt([X({type:String,attribute:"bottom-text",reflect:!0})],vt.prototype,"bottomText");Nt([X({type:String,attribute:"front-text",reflect:!0})],vt.prototype,"frontText");Nt([X({type:String,attribute:"back-text",reflect:!0})],vt.prototype,"backText");Nt([dh()],vt.prototype,"_cssMatrix3D");var bh=Object.defineProperty,gh=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&bh(t,i,o),o};const Wr=class extends Dt{constructor(){super(...arguments),this.world=null,this._components=null,this._viewport=vn()}set components(t){var i;if(this._components=t,this.components){const n=this.components.get(Oi);this.world=n.create(),this.world.name=this.name}else(i=this.world)==null||i.dispose(),this.world=null}get components(){return this._components}connectedCallback(){super.connectedCallback(),this.world&&(this.world.enabled=!0)}disconnectedCallback(){super.disconnectedCallback(),this.world&&(this.world.enabled=!1)}dispose(){this.components=null,this.remove()}firstUpdated(){const{value:t}=this._viewport;if(!(this.components&&t&&this.world))return;const i=new qo(this.components);this.world.scene=i,i.setup(),i.three.background=null;const n=new P(this.components,t);this.world.renderer=n;const{postproduction:o}=n,s=new Yo(this.components);this.world.camera=s;const r=this.components.get(Wo).create(this.world);r.material.uniforms.uColor.value=new ue(4342338),r.material.uniforms.uSize1.value=2,r.material.uniforms.uSize2.value=8,o.enabled=!0,o.customEffects.excludedMeshes.push(r.three),o.setPasses({custom:!0,ao:!0,gamma:!0}),o.customEffects.lineColor=1513756}onSlotChange(){const t=new Event("slotchange");this.dispatchEvent(t)}render(){return jn` <bim-viewport ${Tu(this._viewport)}>
      <slot @slotchange=${this.onSlotChange}></slot>
    </bim-viewport>`}};Wr.styles=Hn``;let Gr=Wr;gh([X({type:String,reflect:!0})],Gr.prototype,"name");class Ch{static init(){W.defineCustomElement("bim-view-cube",vt),W.defineCustomElement("bim-world-2d",$e),W.defineCustomElement("bim-world",Gr)}}export{Ch as w};
